                                                ...
                                                double maxRoll)
{
    ...
    for(double pitch = 0.0, roll = 0.0; pitch >= -maxPitch && roll >= -maxRoll ; pitch -= pitchStepSize, roll -= rollStepSize)
    {
    ...
    std::cout << "Finished tilt calibration: Pitch:" << results.bestTilt.pitch 
        << " Roll:" << results.bestTilt.roll << '\n';

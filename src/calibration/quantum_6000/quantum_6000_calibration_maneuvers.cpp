...
{
    test_configuration_t(system::ModuleCommunicator& transmitter, int numSamples, robot::joystick_command_t& command)
...
/**
 * 2/22/2016 quantum_6000_calibration_maneuvers is used to send out pre-specified joystick commands for robot
 * calibration.
 *

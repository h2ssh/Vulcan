...
struct differential_motors_plant_params_t
{
    ...
    float motorMu =
      0.26;   // mechanical energy loss due to rolling friction. higher alpha can induce higher oscillation
    float motorBeta =
      5.5;   // motor energy change from velocity lower beta induces slower response and higher overshoot

...
pose_t RobotPlantModel::turnDriveTurnIntegration(const pose_t& priorPose, const velocity_t& averageVelocity, const float timestep)
{
...
std::unique_ptr<RobotPlantModel> create_robot_plant_model(const std::string&          type,
                                                          const plant_model_params_t& params)
{

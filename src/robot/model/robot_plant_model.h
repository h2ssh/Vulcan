...
protected:
    /**
     * turnDriveTurnIntegration is a 4-th order fixed-time integration of poses assuming a half_turn-drive-half_turn
     * motion. Rather than doing a direct Euler integral, this method leapfrogs the states based on the average linear
     * and angular velocities. Despite its simplicity, the model does caputure the non-holonmic constraints of the robot
     * (that it cannot move sideways), and we can get satisfactory precison without using external ODE libraries using
     * this very simple, fixed-time integrator.
     *

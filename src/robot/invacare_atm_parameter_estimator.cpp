...
/**
* invacare_atm_parameter_estimator is used to estimate the mapping between joystick position and angular velocity command.
*
* To find the parameter, a big chunk of data is consumed. The test runs all commands between -64 and 64 for a given amount

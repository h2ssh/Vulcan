 ...
 *   sliding_window_size_ms = size of the sliding window to use when estimating velocity by differentiating poses in
 * milliseconds odometry_filter_gain   = Kalman filter gain to use in the odometry velocity filter
 */

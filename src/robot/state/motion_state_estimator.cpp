...
motion_state_estimator_params_t::motion_state_estimator_params_t(const utils::ConfigFile& config,
...
void MotionStateEstimator::estimate(system::ModuleCommunicator& transmitter)
{
    ...
    motion_state_t updatedState(estimatedPose,
                                estimatedVelocity,
                                driveWheelEstimator_.getEstimatedAcceleration(),
                                estimatedWheels);

 ...
 * Additional changes by R Gaynier - I've attempted to make this file match the Quantum_6000.h file as closely as
 * possible to aid my own understanding and analysis. I've noted those changes where they occur.
 *
...
public:
     ...
     */
    InvacareATM(const wheelchair_joystick_calibration_t& calibration,

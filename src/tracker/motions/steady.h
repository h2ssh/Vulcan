...
* object is tracked using a Kalman filter. Motion is assumed to be independent on the x- and y-axes. The velocity of the
* object is estimated using a regression that takes into account the position and time at which a measurement was made.
*/

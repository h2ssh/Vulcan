...
*   max_adjacent_ray_distance_m = maximum distance between adjacent rays for the rays to be considered in the same cluster (meters)
*   min_cluster_rays            = minimum number of consecutive range measurements within the distance threshold for an object to counted as a cluster
*   max_tracking_distance_m     = maximum distance from the robot to track an object (meters)
*   laser_variance              = variance of the laser points measuring the detected objects

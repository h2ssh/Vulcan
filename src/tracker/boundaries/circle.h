...
/**
* CircleBoundary is an estimator for an object with a circle boundary being tracked by a laser. The radius of the circle
* is estimated. The current model at a desired position can be retrieved with the atPosition method which will return
* the estimated boundary centered at that position.
* 

...
private:
    ...
    void matchLaserToSegments(const polar_laser_scan_t& scan,
                              ...
                              std::vector<image_object_t>& objects);
    void
      convertLaserToPixels(const polar_laser_scan_t& scan, int imageHeight, std::vector<Point<int16_t>>& laserPixels);
    ...
    void matchDynamicPointsToSegments(const laser::dynamic_laser_points_t& points,
    ...
    void findPlaneSegmentsAdjacentToDynamic(const std::vector<size_t>& planeIndices,

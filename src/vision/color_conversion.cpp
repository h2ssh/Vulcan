...
void convertImage(uchar* from,
                  uchar* to,
                  uint width,
                  uint height,
                  void (*transform)(uchar, uchar, uchar, uchar&, uchar&, uchar&));
 ...
 */
void vulcan::vision::convertPixelColorspace(uchar fromA,
                                            uchar fromB,
                                            uchar fromC,
                                            uchar& toA,
                                            uchar& toB,
 ...
 */
void vulcan::vision::convertImageColorspace(uchar* from,
                                            uchar* to,
                                            uint width,
                                            uint height,
                                            Colorspace csFrom,
...
void hsvPixelToRGB(uchar h, uchar s, uchar v, uchar& r, uchar& g, uchar& b)
{
    ...
    } else   // not so lucky, need to do full calculation
    {
        ...
        std::cout << "tempX: " << (uchar)(tempX * 255) << " tempY: " << (uchar)(tempY * 255)
                  << " tempZ: " << (uchar)(tempZ * 255) << " V: " << (uchar)(v * 255) << std::endl;
#endif

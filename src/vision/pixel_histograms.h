...
protected:
     ...
     */
    virtual void calculateHistogram(const Image& image, const std::vector<Point<int16_t>>& pixels) = 0;
...
private:
     ...
     * calculateHistogram calculates the histogram using the provided image and the pixel coordinates.
     */
    virtual void calculateHistogram(const Image& image, const std::vector<Point<int16_t>>& pixels);

...
{
    imuLog<<imu.timestamp<<' '
          <<imu.acceleration[IMU_X_INDEX]<<' '<<imu.acceleration[IMU_Y_INDEX]<<' '<<imu.acceleration[IMU_Z_INDEX]<<' '
          <<imu.rotationalVelocity[IMU_YAW_INDEX]<<' '<<imu.rotationalVelocity[IMU_PITCH_INDEX]<<' '<<imu.rotationalVelocity[IMU_ROLL_INDEX]<<' '
          <<imu.orientation[IMU_YAW_INDEX]<<' '<<imu.orientation[IMU_PITCH_INDEX]<<' '<<imu.orientation[IMU_ROLL_INDEX]<<std::endl;
}

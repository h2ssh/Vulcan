...
void vulcan::lcm::convert_lcm_to_vulcan(const vulcan_lcm_velocity_command_t& velocityMessage,
                                        robot::velocity_command_t& velocity)
{
...
void vulcan::lcm::convert_vulcan_to_lcm(const robot::velocity_command_t& velocity,
                                       ...
                                       std::string channel)
{
    ...
    if (!subscribers.isSubscribedToChannel(lcm, channel)) {
        ...
        vulcan_lcm_velocity_command_t_subscribe(
          lcm,
          channel.c_str(),

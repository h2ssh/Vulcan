...
static vulcan::lcm::SubscriptionManager<vulcan_lcm_commanded_velocity_t, vulcan::robot::commanded_velocity_t>
  subscribers;


void vulcan::lcm::convert_lcm_to_vulcan(const vulcan_lcm_commanded_velocity_t& velocityMessage,
                                        robot::commanded_velocity_t& velocity)
{
...
void vulcan::lcm::convert_vulcan_to_lcm(const robot::commanded_velocity_t& velocity,
...
void vulcan::lcm::subscribe_to_message(lcm_t* lcm,
                                       void (*callback)(const robot::commanded_velocity_t&, const std::string&, void*),
                                       void* userdata,
                                       std::string channel)
{
    ...
    if (!subscribers.isSubscribedToChannel(lcm, channel)) {
        ...
        vulcan_lcm_commanded_velocity_t_subscribe(
          lcm,
          channel.c_str(),

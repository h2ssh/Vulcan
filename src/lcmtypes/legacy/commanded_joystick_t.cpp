...
void vulcan::lcm::convert_lcm_to_vulcan(const vulcan_lcm_commanded_joystick_t& joystickMessage, robot::commanded_joystick_t& joystick)
{
...
void vulcan::lcm::convert_vulcan_to_lcm(const robot::commanded_joystick_t& joystick, vulcan_lcm_commanded_joystick_t& joystickMessage)
{
...
void vulcan::lcm::subscribe_to_message(lcm_t* lcm, void (*callback)(const robot::commanded_joystick_t&, const std::string&, void*), void* userdata, std::string channel)
{
    ...
    if(!subscribers.isSubscribedToChannel(lcm, channel))
    {
        ...
        vulcan_lcm_commanded_joystick_t_subscribe(lcm, channel.c_str(),

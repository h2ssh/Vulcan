...
void publish_data(lcm_t* lcm, const robot::velocity_command_t& velocity, const std::string& channel = VELOCITY_COMMAND_CHANNEL);
void subscribe_to_message(lcm_t* lcm, void (*callback)(const robot::velocity_command_t&, const std::string&, void*), void* userdata, std::string channel = VELOCITY_COMMAND_CHANNEL);

...
template <>
struct message_traits<vulcan_lcm::load_lpm_command>
{
     ...
     */
    static std::string channelName(int index) { return "LOAD_LPM"; }
};

}   // namespace system
}   // namespace vulcan

#endif   // LCMTYPES_COMMANDS_LOAD_LPM_COMMAND_T_LCM

...
#ifndef LCMTYPES_MPEPC_METRIC_POSE_TARGET_H
#define LCMTYPES_MPEPC_METRIC_POSE_TARGET_H

#include "lcmtypes/vulcan_lcm/metric_pose_target_t.hpp"
...
template <>
struct message_traits<vulcan_lcm::metric_pose_target_t>
{
     ...
     */
    static std::string channelName(int index) { return "METRIC_POSE_TARGET"; }
};

}   // namespace system
}   // namespace vulcan

#endif   // LCMTYPES_MPEPC_METRIC_POSE_TARGET_H

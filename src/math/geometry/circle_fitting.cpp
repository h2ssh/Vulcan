                                             ...
                                             double* fitError)
{
    ...
    if ((initialGuess.radius() >= minRadius) && (initialGuess.radius() <= maxRadius)) {
        ...
        if (fitResult != 0) {
            //             std::cerr << "WARNING: minimum_geometric_error_circle: Failed to find proper fit! Using
            //             algebraic fit.\n";
        ...
        if ((fitCircle.radius() < minRadius) || (fitCircle.radius() > maxRadius)) {
            //             std::cerr << "WARNING: minimum_geometric_error_circle: Geometric fit circle too big or
            //             small."

...
*
*   - axis_aligned_bounding_rectangle   : smallest rectangle that fits around all the points while aligned to the axes of the coordinate system
...
*   - mean_position_and_radius_circle   : circle whose center is the mean of the points and radius is the mean of the radius to the points from this center
*/
...
*
* When looking at the results, the LMA method is used. LMA is chosen because it works best for circles where only a small
* subset of the points along the circumference are seen. This condition is very true for any measurements taken by
* a laser rangefinder since it will necessarily see no more than half, but likely much less, the circle.
*
...
/**
* mean_position_and_radius_circle is a simple circle fitting that puts the center of the circle at the mean of the points and the radius
* of the circle is the mean radius from this center to each of the points.
*

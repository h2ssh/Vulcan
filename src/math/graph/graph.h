...
{
    graph_vertex_t(void) : numAdjacent(0) { }
...
public:
     ...
     */
    void addVertex(graph_vertex_t<T, N>* vertex) { vertices.push_back(vertex); }
     ...
     */
    const std::vector<graph_vertex_t<T, N>*>& getVertices(void) const { return vertices; }

...
public:
     ...
     *
     * \param    useCachedGraph      Flag indicating if the returned graph should use vertices that are cached in
     * AllPaths meaning the returned subgraph memory is owned by AllPaths rather than the callee
     */

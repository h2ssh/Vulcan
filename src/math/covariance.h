 ...
 * \param    startWeight         Start weight for the weights to apply to the points. Must be valid for dist(start,
 * end). \return   2x2 covariance matrix of the values.
 */
 ...
 */
template <typename PointIterator, typename WeightIterator>
point2D_covariance_properties_t
  point2D_covariance_properties(PointIterator startPoint, PointIterator endPoint, WeightIterator startWeight)
{

...
* 
* Declaration of functions implementing Savitzky-Golay filtering for smoothing data or calculating smoothed derivatives:
* 
...
/**
* savitzky_golay_second_deriv calculates the second derivative of the input data and stores it in the output. The radius 
* and polynomial to fit can be specified, but default to radius = 2 and quadratic polynomial.
* 
* \param    begin           Start of the data
* \param    end             End of the data

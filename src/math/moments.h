...
{
    return std::accumulate(begin, end, 0.0, [=](double total, const Point<double>& point) {
 ...
 */
template <class PointIterator>
double scale_invariant_moment(PointIterator begin,
                              PointIterator end,
                              int xExp,
                              int yExp,
                              double area,
 ...
 */
template <class PointIterator>
SecondOrderMoments second_order_central_moments(PointIterator begin, PointIterator end, const Point<double>& center)
{
 ...
 */
template <class PointIterator>
ThirdOrderMoments third_order_central_moments(PointIterator begin, PointIterator end, const Point<double>& center)
{
...
template <class PointIterator>
ThirdOrderMoments
  third_order_scale_invariant_moments(PointIterator begin, PointIterator end, double area, const Point<double>& center)
{
    ThirdOrderMoments moments;

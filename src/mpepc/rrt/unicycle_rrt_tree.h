...
public:
     ...
     */
    std::vector<nodePtr>
      findNearbyNodesFromPose(const pose_t& pose, float distanceThreshold, bool isMovingBackward = false);
     ...
     */
    std::vector<nodePtr>
      findNearbyNodesToPose(const pose_t& pose, float distanceThreshold, bool isMovingBackward = false);

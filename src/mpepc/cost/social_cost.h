...
{
    ar(params.defaultResponsePlace, params.defaultResponsePath, params.responses, params.numLateralBins);
}

template <class Archive>
void serialize(Archive& ar, learned_norm_info_t& debug)
{
    ar(debug.agents, debug.pathSituations, debug.placeSituations);
}

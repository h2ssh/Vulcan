...
namespace robot { struct velocity_command_t; }
...
private:
    ...
    robot::velocity_command_t calculateKappaLinearCommand      (const graceful_motion_coordinates_t& coords, const graceful_motion_output_t& motion);
    robot::velocity_command_t calculateSlowdownLinearCommand   (const graceful_motion_coordinates_t& coords, const graceful_motion_output_t& motion);
    robot::velocity_command_t calculateAttenuatedAngularCommand(const graceful_motion_coordinates_t& coords, const graceful_motion_output_t& motion);
    robot::velocity_command_t calculateSpeedupLinearCommand    (const graceful_motion_coordinates_t& coords, const graceful_motion_output_t& motion);
    robot::velocity_command_t calculateFinalTargetCommand      (const graceful_motion_coordinates_t& coords, const graceful_motion_output_t& motion);

...
/**
 * MotionTargetFollowingController is the new implementation of the GracefulMotionController, with time-dependent
 * convergence, ability to move backward, and the feedforward and feedback control structure. TODO: update the
 * description.
 */

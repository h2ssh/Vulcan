...
////////////////////////   GridPath definition   ///////////////////////////////
GridPath::GridPath(const std::vector<Point<int>>& cells, const NavigationGrid& grid) : cells_(cells)
{
...
GridPath::GridPath(const std::vector<Point<float>>& positions, const NavigationGrid& grid) : positions_(positions)
{

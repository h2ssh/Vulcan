 ...
 * (3) simulatorKinematicRobotPlantModel, which is a kinematic robot plant model for approximate, dynamic-free
 * estimation; (4) simulatorDynamicRobotPlantModel, a fully dynamic robot plant model for accurate prediction.
 *

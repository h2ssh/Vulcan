...
*
* Declaration of interaction_social_forces for computing various social force metrics for interactions between the robot
...
struct passing_object_t
{
    ...
    passing_object_t(position_t position,
                     double distance,
                     double speed,
                     math::RectSide side)
    : position(position)

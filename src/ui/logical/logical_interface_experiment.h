...
struct logical_experiment_task_t
{
    ...
    logical_experiment_task_t(void)
        : id(-1)
        , goalId(-1)
        , level(LOGICAL_ANY)
    {
...
*   mixed_mode_goal_ratio = [0,1] in mix mode, number 0-1 is selected. All numbers below the ratio will be assigned 'goal'
*
*/
...
public:
    ...
    */
    LogicalInterfaceExperiment(const logical_interface_experiment_params_t& params, const std::string& evaluationFilename);

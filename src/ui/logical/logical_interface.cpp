...
LogicalFrame::LogicalFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : UIMainFrame( parent, id, title, pos, size, style )
{
	...
	decisionButton->SetFont( wxFont( 30, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("sans") ) );
...
DecisionDialog::DecisionDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	forwardDecisionButton = new wxToggleButton( this, ID_FORWARD_DECISION_BUTTON, wxT("Forward"), wxDefaultPosition, wxDefaultSize, 0 );
	forwardDecisionButton->SetFont( wxFont( 30, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	leftDecisionButton = new wxToggleButton( this, ID_LEFT_DECISION_BUTTON, wxT("Left"), wxDefaultPosition, wxDefaultSize, 0 );
	leftDecisionButton->SetFont( wxFont( 30, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

	turnCommandSizer->Add( leftDecisionButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );

	rightDecisionButton = new wxToggleButton( this, ID_RIGHT_DECISION_BUTTON, wxT("Right"), wxDefaultPosition, wxDefaultSize, 0 );
	rightDecisionButton->SetFont( wxFont( 30, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	backDecisionButton = new wxToggleButton( this, ID_BACK_DECISION_BUTTON, wxT("  Back  "), wxDefaultPosition, wxDefaultSize, 0 );
	backDecisionButton->SetFont( wxFont( 30, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	decisionGoButton->SetFont( wxFont( 30, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("sans") ) );
...
GoalDialog::GoalDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	goalList = new wxListBox( this, ID_GOAL_LIST, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_NEEDED_SB|wxLB_SINGLE );
...
TaskDialog::TaskDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	taskGoalText->Wrap( -1 );
	taskGoalText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	goalIdText->Wrap( -1 );
	goalIdText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

	taskAssignmentSizer->Add( goalIdText, 0, wxALL, 5 );

	interfaceToUseText = new wxStaticText( this, wxID_ANY, wxT("Interface to use:"), wxDefaultPosition, wxDefaultSize, 0 );
	interfaceToUseText->Wrap( -1 );
	interfaceToUseText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	interfaceText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	taskOkButton->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
...
TaskCompleteDialog::TaskCompleteDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	taskCompleteText = new wxStaticText( this, wxID_ANY, wxT("Great! You reached the goal.\n\nHit 'Ok' for your next task."), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
	taskCompleteText->Wrap( -1 );
	taskCompleteText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	completeHiddenText->SetFont( wxFont( 20, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

	taskCompleteSizer->Add( completeHiddenText, 0, wxALL, 5 );

	taskCompleteOkButton = new wxButton( this, ID_TASK_COMPLETE_OK_BUTTON, wxT("Ok"), wxDefaultPosition, wxDefaultSize, 0 );
	taskCompleteOkButton->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
...
ExperimentCompleteDialog::ExperimentCompleteDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	experimentCompleteText = new wxStaticText( this, wxID_ANY, wxT("The experiment is finished.\n\nThank you!"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
	experimentCompleteText->Wrap( -1 );
	experimentCompleteText->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	experimentHiddenText->SetFont( wxFont( 20, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

	experimentCompleteSizer->Add( experimentHiddenText, 0, wxALL, 5 );

	experimentDoneButton = new wxButton( this, ID_EXPERIMENT_DONE_BUTTON, wxT("Done"), wxDefaultPosition, wxDefaultSize, 0 );
	experimentDoneButton->SetFont( wxFont( 25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

...
LogicalFrame::LogicalFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : UIMainFrame( parent, id, title, pos, size, style )
{
	...
	decisionButton->SetFont( wxFont( 30, 74, 90, 90, false, wxT("sans") ) );
	...
	goalButton->SetFont( wxFont( 30, 74, 90, 90, false, wxT("sans") ) );
	...
	stopButton->SetFont( wxFont( 45, 74, 90, 90, false, wxT("sans") ) );
...
DecisionDialog::DecisionDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	forwardDecisionButton->SetFont( wxFont( 30, 70, 90, 90, false, wxEmptyString ) );
	...
	leftDecisionButton->SetFont( wxFont( 30, 70, 90, 90, false, wxEmptyString ) );
	...
	rightDecisionButton->SetFont( wxFont( 30, 70, 90, 90, false, wxEmptyString ) );
	...
	backDecisionButton->SetFont( wxFont( 30, 70, 90, 90, false, wxEmptyString ) );
	...
	decisionGoButton->SetFont( wxFont( 30, 74, 90, 90, false, wxT("sans") ) );
...
GoalDialog::GoalDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	goalList->SetFont( wxFont( 20, 74, 90, 90, false, wxT("sans") ) );
	...
	goalGoButton->SetFont( wxFont( 30, 74, 90, 90, false, wxT("sans") ) );
...
TaskDialog::TaskDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	taskGoalText->Wrap( -1 );
	taskGoalText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	goalIdText->Wrap( -1 );
	goalIdText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	interfaceToUseText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	interfaceText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	taskOkButton->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
...
TaskCompleteDialog::TaskCompleteDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	taskCompleteText = new wxStaticText( this, wxID_ANY, wxT("Great! You reached the goal.\n\nHit 'Ok' for your next task."), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	taskCompleteText->Wrap( -1 );
	taskCompleteText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	completeHiddenText->SetFont( wxFont( 20, 70, 90, 90, false, wxEmptyString ) );
	...
	taskCompleteOkButton->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
...
ExperimentCompleteDialog::ExperimentCompleteDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	experimentCompleteText = new wxStaticText( this, wxID_ANY, wxT("The experiment is finished.\n\nThank you!"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	experimentCompleteText->Wrap( -1 );
	experimentCompleteText->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );
	...
	experimentHiddenText->SetFont( wxFont( 20, 70, 90, 90, false, wxEmptyString ) );
	...
	experimentDoneButton->SetFont( wxFont( 25, 70, 90, 90, false, wxEmptyString ) );

...
*/
class PlaygroundPanel : public UIPanel
...
public:
    ...
    */
    PlaygroundPanel(const playground_panel_widgets_t& widgets, const control_law_dialog_widgets_t& controlWidgets, const calibration_ui_params_t& params);

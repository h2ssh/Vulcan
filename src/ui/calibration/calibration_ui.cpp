...
CalibrationFrame::CalibrationFrame(wxWindow* parent,
                                   wxWindowID id,
...
: UIMainFrame(parent, id, title, pos, size, style)
{
    ...
    calibrationNotebook =
      new wxAuiNotebook(this, ID_CALIBRATION_NOTEBOOK, wxDefaultPosition, wxDefaultSize, wxAUI_NB_DEFAULT_STYLE);
    wheelchairPanel =
      new wxPanel(calibrationNotebook, ID_WHEELCHAIR_PANEL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    ...
    tasksCompletedLabelText =
      new wxStaticText(wheelchairPanel, wxID_ANY, wxT("# Tasks Completed:"), wxDefaultPosition, wxDefaultSize, 0);
    tasksCompletedLabelText->Wrap(-1);
    tasksCompletedLabelText->SetFont(
    ...
    tasksCompletedText =
      new wxStaticText(wheelchairPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    tasksCompletedText->Wrap(-1);
    tasksCompletedText->SetFont(
      wxFont(16, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    taskNotesLabelText =
      new wxStaticText(wheelchairPanel, wxID_ANY, wxT("Task Notes:"), wxDefaultPosition, wxDefaultSize, 0);
    taskNotesLabelText->Wrap(-1);
    taskNotesLabelText->SetFont(
    ...
    testResultsLabelText =
      new wxStaticText(wheelchairPanel, wxID_ANY, wxT("Test Results"), wxDefaultPosition, wxDefaultSize, 0);
    testResultsLabelText->Wrap(-1);
    testResultsLabelText->SetFont(
      wxFont(16, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, true, wxEmptyString));
    ...
    systemDataLabel =
      new wxStaticText(wheelchairPanel, wxID_ANY, wxT("System Data"), wxDefaultPosition, wxDefaultSize, 0);
    systemDataLabel->Wrap(-1);
    systemDataLabel->SetFont(
      wxFont(16, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, true, wxEmptyString));
    ...
    wxString wheelchairTestSelectionBoxChoices[] = {wxT("Stopping Distance"),
                                                    wxT("Minimum Stopped Speed"),
                                                    wxT("Minimum Rolling Speed"),
                                                    wxT("Parameter Estimator")};
    int wheelchairTestSelectionBoxNChoices = sizeof(wheelchairTestSelectionBoxChoices) / sizeof(wxString);
    wheelchairTestSelectionBox = new wxRadioBox(wheelchairPanel,
                                                ID_WHEELCHAIR_TEST_SELECTION_BOX,
                                                wxT("Wheelchair Tests:"),
                                                wxDefaultPosition,
                                                wxDefaultSize,
                                                wheelchairTestSelectionBoxNChoices,
                                                wheelchairTestSelectionBoxChoices,
                                                1,
                                                wxRA_SPECIFY_COLS);
    ...
    cancelTestButton =
      new wxButton(wheelchairPanel, ID_CANCEL_TEST_BUTTON, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    playgroundWidget =
      new PlaygroundDisplayWidget(playgroundPanel, ID_PLAYGROUND_WIDGET, wxDefaultPosition, wxDefaultSize);
    playgroundPanelSizer->Add(playgroundWidget, 1, wxALL | wxEXPAND, 5);

    playgroundSettingsLine =
      new wxStaticLine(playgroundPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL);
    ...
    controllerParametersLabel =
      new wxStaticText(playgroundPanel, wxID_ANY, wxT("Controller Parameters:"), wxDefaultPosition, wxDefaultSize, 0);
    controllerParametersLabel->Wrap(-1);
    controllerParametersLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
    ...
    createControllerParametersButton = new wxButton(playgroundPanel,
                                                    ID_CREATE_CONTROLLER_PARAMETERS_BUTTON,
                                                    wxT("Create"),
                                                    wxDefaultPosition,
                                                    wxDefaultSize,
                                                    0);
    ...
    loadControllerParametersButton = new wxButton(playgroundPanel,
                                                  ID_LOAD_CONTROLLER_PARAMETERS_BUTTON,
                                                  wxT("Load"),
                                                  wxDefaultPosition,
                                                  wxDefaultSize,
                                                  0);
    ...
    saveControllerParametersButton = new wxButton(playgroundPanel,
                                                  ID_SAVE_CONTROLLER_PARAMETERS_BUTTON,
                                                  wxT("Save"),
                                                  wxDefaultPosition,
                                                  wxDefaultSize,
                                                  0);
    ...
    playgroundBoundaryLabel =
      new wxStaticText(playgroundPanel, wxID_ANY, wxT("Playground Boundary:"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundBoundaryLabel->Wrap(-1);
    playgroundBoundaryLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                            wxFONTFAMILY_DEFAULT,
                                            wxFONTSTYLE_NORMAL,
                                            wxFONTWEIGHT_BOLD,
                                            false,
    ...
    setPlaygroundBoundaryButton =
      new wxButton(playgroundPanel, ID_SET_PLAYGROUND_BOUNDARY_BUTTON, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(setPlaygroundBoundaryButton, wxGBPosition(3, 0), wxGBSpan(1, 1), wxALL, 5);

    donePlaygroundBoundaryButton = new wxButton(playgroundPanel,
                                                ID_DONE_PLAYGROUND_BOUNDARY_BUTTON,
                                                wxT("Done"),
                                                wxDefaultPosition,
                                                wxDefaultSize,
                                                0);
    ...
    clearPlaygroundBoundaryButton = new wxButton(playgroundPanel,
                                                 ID_CLEAR_PLAYGROUND_BOUNDARY_BUTTON,
                                                 wxT("Clear"),
                                                 wxDefaultPosition,
                                                 wxDefaultSize,
                                                 0);
    ...
    targetRegionLabel =
      new wxStaticText(playgroundPanel, wxID_ANY, wxT("Target Region:"), wxDefaultPosition, wxDefaultSize, 0);
    targetRegionLabel->Wrap(-1);
    targetRegionLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                      wxFONTFAMILY_DEFAULT,
                                      wxFONTSTYLE_NORMAL,
                                      wxFONTWEIGHT_BOLD,
                                      false,
    ...
    setTargetRegionButton =
      new wxButton(playgroundPanel, ID_SET_TARGET_REGION_BUTTON, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(setTargetRegionButton, wxGBPosition(5, 0), wxGBSpan(1, 1), wxALL, 5);

    doneTargetRegionButton =
      new wxButton(playgroundPanel, ID_DONE_TARGET_REGION_BUTTON, wxT("Done"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(doneTargetRegionButton, wxGBPosition(5, 1), wxGBSpan(1, 1), wxALL, 5);

    clearTargetRegionButton =
      new wxButton(playgroundPanel, ID_CLEAR_TARGET_REGION_BUTTON, wxT("Clear"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    vMaxLabel->Wrap(-1);
    vMaxLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                              wxFONTFAMILY_DEFAULT,
                              wxFONTSTYLE_NORMAL,
                              wxFONTWEIGHT_BOLD,
                              false,
    ...
    playgroundSetupSizer->Add(vMaxLabel,
                              wxGBPosition(6, 0),
                              wxGBSpan(1, 1),
    ...
    calcVMaxButton =
      new wxButton(playgroundPanel, ID_CALC_VMAX_BUTTON, wxT("Calc"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(calcVMaxButton, wxGBPosition(6, 2), wxGBSpan(1, 1), wxALL, 5);

    numTargetsLabel =
      new wxStaticText(playgroundPanel, wxID_ANY, wxT("# Targets:"), wxDefaultPosition, wxDefaultSize, 0);
    numTargetsLabel->Wrap(-1);
    numTargetsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                    wxFONTFAMILY_DEFAULT,
                                    wxFONTSTYLE_NORMAL,
                                    wxFONTWEIGHT_BOLD,
                                    false,
    ...
    playgroundSetupSizer->Add(numTargetsLabel,
                              wxGBPosition(7, 0),
                              wxGBSpan(1, 1),
                              wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL,
                              5);
    ...
    numTargetsText =
      new wxTextCtrl(playgroundPanel, ID_NUM_TARGETS_TEXT, wxT("100"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT);
    playgroundSetupSizer->Add(numTargetsText, wxGBPosition(7, 1), wxGBSpan(1, 1), wxALIGN_CENTER | wxALL, 5);

    timePerTargetLabel =
      new wxStaticText(playgroundPanel, wxID_ANY, wxT("Time/Target:"), wxDefaultPosition, wxDefaultSize, 0);
    timePerTargetLabel->Wrap(-1);
    timePerTargetLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                       wxFONTFAMILY_DEFAULT,
                                       wxFONTSTYLE_NORMAL,
                                       wxFONTWEIGHT_BOLD,
                                       false,
    ...
    playgroundSetupSizer->Add(timePerTargetLabel,
                              wxGBPosition(8, 0),
                              wxGBSpan(1, 1),
                              wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL,
                              5);
    ...
    timePerTargetText =
      new wxTextCtrl(playgroundPanel, ID_TIME_PER_TARGET_TEXT, wxT("10"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT);
    ...
    playgroundSetupSizer->Add(timeSecondsLabel,
                              wxGBPosition(8, 2),
                              wxGBSpan(1, 1),
    ...
    logNameLabel->Wrap(-1);
    logNameLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                 wxFONTFAMILY_DEFAULT,
                                 wxFONTSTYLE_NORMAL,
                                 wxFONTWEIGHT_BOLD,
                                 false,
    ...
    playgroundSetupSizer->Add(logNameLabel,
                              wxGBPosition(9, 0),
                              wxGBSpan(1, 1),
                              wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL,
                              5);

    logNameText = new wxTextCtrl(playgroundPanel,
                                 ID_LOG_NAME_TEXT,
                                 wxT("playground_data.log"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0);
    ...
    startSessionButton =
      new wxButton(playgroundPanel, ID_START_SESSION_BUTTON, wxT("Start"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(startSessionButton, wxGBPosition(10, 0), wxGBSpan(1, 1), wxALL, 5);

    pauseSessionButton =
      new wxButton(playgroundPanel, ID_PAUSE_SESSION_BUTTON, wxT("Pause"), wxDefaultPosition, wxDefaultSize, 0);
    playgroundSetupSizer->Add(pauseSessionButton, wxGBPosition(10, 1), wxGBSpan(1, 1), wxALL, 5);

    stopSessionButton =
      new wxButton(playgroundPanel, ID_STOP_SESSION_BUTTON, wxT("Stop"), wxDefaultPosition, wxDefaultSize, 0);
...
WheelchairTestSetup::WheelchairTestSetup(wxWindow* parent,
                                         wxWindowID id,
                                         const wxString& title,
                                         const wxPoint& pos,
                                         const wxSize& size,
...
: wxDialog(parent, id, title, pos, size, style)
{
    ...
    testNameText = new wxTextCtrl(testNameSizer->GetStaticBox(),
                                  ID_TEST_NAME_TEXT,
                                  wxT("Test Name"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
    ...
    testCommandModeRadioBox = new wxRadioBox(this,
                                             ID_TEST_COMMAND_MODE_RADIO_BOX,
                                             wxT("Command Mode"),
                                             wxDefaultPosition,
                                             wxDefaultSize,
                                             testCommandModeRadioBoxNChoices,
                                             testCommandModeRadioBoxChoices,
                                             1,
                                             wxRA_SPECIFY_COLS);
    ...
    rampDurationLabel = new wxStaticText(this,
                                         ID_RAMP_DURATION_LABEL,
                                         wxT("Ramp Duration (change/sec):"),
                                         wxDefaultPosition,
                                         wxDefaultSize,
                                         0);
    ...
    rampDurationText =
      new wxTextCtrl(this, ID_RAMP_DURATION_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_RIGHT);
...
ControlLawParameters::ControlLawParameters(wxWindow* parent,
                                           wxWindowID id,
                                           const wxString& title,
                                           const wxPoint& pos,
                                           const wxSize& size,
...
: wxDialog(parent, id, title, pos, size, style)
{
    ...
    k1Label->Wrap(-1);
    k1Label->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                            wxFONTFAMILY_DEFAULT,
                            wxFONTSTYLE_NORMAL,
                            wxFONTWEIGHT_BOLD,
                            false,
    ...
    k2Label->Wrap(-1);
    k2Label->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                            wxFONTFAMILY_DEFAULT,
                            wxFONTSTYLE_NORMAL,
                            wxFONTWEIGHT_BOLD,
                            false,
    ...
    maxLinearLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                   wxFONTFAMILY_DEFAULT,
                                   wxFONTSTYLE_NORMAL,
                                   wxFONTWEIGHT_BOLD,
                                   false,
    ...
    maxAngularVelLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                       wxFONTFAMILY_DEFAULT,
                                       wxFONTSTYLE_NORMAL,
                                       wxFONTWEIGHT_BOLD,
                                       false,
    ...
    angVelAtTargetLabel =
      new wxStaticText(this, wxID_ANY, wxT("Angular Vel at Target:"), wxDefaultPosition, wxDefaultSize, 0);
    angVelAtTargetLabel->Wrap(-1);
    angVelAtTargetLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                        wxFONTFAMILY_DEFAULT,
                                        wxFONTSTYLE_NORMAL,
                                        wxFONTWEIGHT_BOLD,
                                        false,
    ...
    slowdownRadiusLabel =
      new wxStaticText(this, wxID_ANY, wxT("Slowdown Radius:"), wxDefaultPosition, wxDefaultSize, 0);
    slowdownRadiusLabel->Wrap(-1);
    slowdownRadiusLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                        wxFONTFAMILY_DEFAULT,
                                        wxFONTSTYLE_NORMAL,
                                        wxFONTWEIGHT_BOLD,
                                        false,
    ...
    convergenceRadius =
      new wxStaticText(this, wxID_ANY, wxT("Convergence Radius:"), wxDefaultPosition, wxDefaultSize, 0);
    convergenceRadius->Wrap(-1);
    convergenceRadius->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                      wxFONTFAMILY_DEFAULT,
                                      wxFONTSTYLE_NORMAL,
                                      wxFONTWEIGHT_BOLD,
                                      false,
    ...
    convergenceAngleLabel =
      new wxStaticText(this, wxID_ANY, wxT("Convergence Angle:"), wxDefaultPosition, wxDefaultSize, 0);
    convergenceAngleLabel->Wrap(-1);
    convergenceAngleLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                          wxFONTFAMILY_DEFAULT,
                                          wxFONTSTYLE_NORMAL,
                                          wxFONTWEIGHT_BOLD,
                                          false,
    ...
    betaLabel->Wrap(-1);
    betaLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                              wxFONTFAMILY_DEFAULT,
                              wxFONTSTYLE_NORMAL,
                              wxFONTWEIGHT_BOLD,
                              false,
    ...
    lambdaLabel->Wrap(-1);
    lambdaLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                wxFONTFAMILY_DEFAULT,
                                wxFONTSTYLE_NORMAL,
                                wxFONTWEIGHT_BOLD,
                                false,
    ...
    controlLawDialogOkayButton =
      new wxButton(this, ID_CONTROL_LAW_DIALOG_OKAY_BUTTON, wxT("Okay"), wxDefaultPosition, wxDefaultSize, 0);
    controlLawSizer->Add(controlLawDialogOkayButton, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL, 5);

    controlLawDialogCancelButton =
      new wxButton(this, ID_CONTROL_LAW_DIALOG_CANCEL_BUTTON, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0);

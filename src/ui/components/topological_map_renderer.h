...
private:
    ...
    void drawPathSegment(const hssh::GlobalPathSegment& segment,
    ...
    void drawPathLocation(const hssh::GlobalLocation& location,
    ...
    map_place_info_t
      create_place_info(hssh::Id placeId, const hssh::TopologicalState& topoMap, const hssh::MetricMapCache& places);

...
void GradientGridRenderer::setGradientGrid(const utils::CellGrid<int16_t>& dxGrid,
                                           const utils::CellGrid<int16_t>& dyGrid)
{
...
void GradientGridRenderer::createVertices(const utils::CellGrid<int16_t>& dxGrid,
                                          const utils::CellGrid<int16_t>& dyGrid)
{

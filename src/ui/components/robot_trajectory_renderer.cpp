...
void RobotTrajectoryRenderer::renderPath(const std::vector<Point<float>>& path,
...
void RobotTrajectoryRenderer::renderPiecewiseCosts(const std::vector<pose_t>& trajectory,
                                                   const std::vector<float>& piecewiseCosts)
{
...
void RobotTrajectoryRenderer::renderRobotsOverTrajectory(const std::vector<pose_t>& trajectory,
                                                         const RobotRenderer& robotRenderer,
                                                         uint numRobots) const
{
    if (numRobots <= 0) {
...
void RobotTrajectoryRenderer::renderMotionTarget(const mpepc::motion_target_t& motionTarget,
                                                 const GLColor& motionTargetColor) const
{

...
namespace hssh { class DebugHypothesis; }
namespace ui
{

/**
* AreaHypothesisRenderer draws the AreaHypotheses used in the AreaParser to the screen. The drawn hypotheses show the following information:
*
...
public:
    ...
    */
    ...
    /**
    * setRenderColor sets the color to render the hypotheses based on their types. There is a separate color for each possible
    ...
    * color is assigned its own channel -- red, green, or blue -- and the final color is a weighted combination of these
    * colors.
    */

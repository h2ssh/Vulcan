...
namespace vulcan
{
namespace hssh { class CSPDebugInfo; }
namespace hssh { class CSPArea; }
namespace hssh { class CSPIteration; }
namespace ui
{
...
private:
    ...
    std::unique_ptr<AreaExtentRenderer> extentRenderer_; // Render to use for drawing the underlying assignment of labels

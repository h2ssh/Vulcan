...
void add_point_to_vertices(const Point<float>& point,
                           float size,
                           const GLColor& color,
                           std::vector<GLfloat>& vertices,
                           std::vector<GLfloat>& colors);
...
void VoronoiIsovistGradientsRenderer::setRenderColors(const GLColor& localMaximaColor,
                                                      const std::vector<GLColor>& gradientColors)
{
...
void VoronoiIsovistGradientsRenderer::setProbabilities(const hssh::CellToTypeMap<double>& probabilities,
                                                       const hssh::VoronoiSkeletonGrid& grid)
{
    convert_probabilities_to_vertices(probabilities, grid, interpolator_, probabilitiesVertices_, probabilitiesColors_);
}

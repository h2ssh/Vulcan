...
namespace vulcan
{
namespace hssh { class HypothesisTree; }
namespace hssh { struct hypothesis_tree_node_t; }
namespace ui
{
...
private:
    ...
    */
    ...
    void changeNodeColor(uint32_t id, const GLColor& color); // for setting a color outside of when a tree is being built
};

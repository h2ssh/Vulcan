...
namespace laser { class ReflectedLaserScan; }
namespace robot { struct proximity_warning_indices_t; }
...
private:
    ...
    void drawScan(const polar_laser_scan_t& scan,
                  const pose_6dof_t& laserPose,

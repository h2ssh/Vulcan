...
/**
 * LaserObjectRenderer renders LaserObjects. A LaserObject can be drawn using the rectangle, one-circle, or two-circle
 * boundaries. The laser points associated with the object can be drawn. The covariance matrix for the object can also
 * be drawn.
 *
...
public:
     ...
     */
    void renderObjects(const tracker::LaserObjectCollection& objects, tracker::BoundaryType boundary, int options = 0);

...
public:
    ...
    void setGateways(
      const std::vector<hssh::Gateway>& gateways);   // The LocalTopoPanel manages which gateways should be shown
    ...
    void setIsovistGradients(std::shared_ptr<hssh::VoronoiIsovistGradients> gradients,

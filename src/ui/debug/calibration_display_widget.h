...
public:
    ...
    void setFrontLaserPoseInRobotFrame(const pose_6dof_t& laserPoseInRobotFrame) { frontLaserPoseInRobotFrame = laserPoseInRobotFrame; };
    void setBackLaserPoseInRobotFrame (const pose_6dof_t& laserPoseInRobotFrame) { backLaserPoseInRobotFrame  = laserPoseInRobotFrame; };

...
/**
 * GlobalMetricPanel controls the I/O for the Global Metric tab in the DebugUI. The GlobalMetricPanel performs the
 * following tasks for the display of debugging information:
 *

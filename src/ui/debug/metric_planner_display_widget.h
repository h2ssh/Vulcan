...
public:
    ...
    */
    ...
    void setTrajectoryCostToShow(size_t selection) { trjCostType_ = static_cast<mpepc::robot_trajectory_debug_cost_type_t>(selection); };
    ...
    void handleData(const std::vector<mpepc::dynamic_object_trajectory_debug_info_t>& objectTrajectories, const std::string& channel);
    void handleData(const std::vector<mpepc::dynamic_object_trajectory_t>&            objectTrajectories, const std::string& channel);
...
//     void handleData(const mpepc::rrt_info_t&                               rrtInfo,            const std::string& channel);

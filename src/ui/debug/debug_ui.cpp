...
DebugFrame::DebugFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : UIMainFrame( parent, id, title, pos, size, style )
{
	...
	poseLabel->Wrap( -1 );
	poseLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	poseDisplay->Wrap( -1 );
	poseDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	measuredVelLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	velocityDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	imuLabel->Wrap( -1 );
	imuLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	imuAccelDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	commandLabel->Wrap( -1 );
	commandLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	commandDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	leftWheelLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	leftWheelDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	imuVelocityLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	imuVelocityDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	rightWheelLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	rightWheelDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	imuOrientationLabel->SetFont( wxFont( 12, 74, 90, 92, false, wxT("Sans") ) );
	...
	imuOrientationDisplay->SetFont( wxFont( 12, 74, 90, 90, false, wxT("Fixed") ) );
	...
	laserToShowRadio = new wxRadioBox( localMetricScrollWindow, ID_LASER_TO_SHOW_RADIO, wxT("Laser To Show:"), wxDefaultPosition, wxDefaultSize, laserToShowRadioNChoices, laserToShowRadioChoices, 1, wxRA_SPECIFY_COLS );
	laserToShowRadio->SetSelection( 0 );
	laserDisplayOptionsSizer->Add( laserToShowRadio, 0, wxALL|wxEXPAND, 5 );
	
	scanLineCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_LASER_LINES_BOX, wxT("Show Laser Rays"), wxDefaultPosition, wxDefaultSize, 0 );
	laserDisplayOptionsSizer->Add( scanLineCheckBox, 0, wxALL, 5 );
	
	showExtractedLinesCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_EXTRACTED_LINES_BOX, wxT("Show Extracted Lines"), wxDefaultPosition, wxDefaultSize, 0 );
	laserDisplayOptionsSizer->Add( showExtractedLinesCheckBox, 0, wxALL, 5 );
	
	showIntensityPlotsCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_INTENSITY_PLOTS_BOX, wxT("Show intensity Plots"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showPoseTraceCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_POSE_TRACE, wxT("Show Pose Trace"), wxDefaultPosition, wxDefaultSize, 0 );
	showPoseTraceCheckBox->SetValue(true); 
	localizationOptionsSizer->Add( showPoseTraceCheckBox, 0, wxALL, 5 );
	
	showMotionTraceCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_MOTION_TRACE_BOX, wxT("Show Motion Trace"), wxDefaultPosition, wxDefaultSize, 0 );
	showMotionTraceCheckBox->SetValue(true); 
	localizationOptionsSizer->Add( showMotionTraceCheckBox, 0, wxALL, 5 );
	
	showUncertaintyEllipseCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_UNCERTAINTY_ELLIPSE, wxT("Show Error Ellipse"), wxDefaultPosition, wxDefaultSize, 0 );
	showUncertaintyEllipseCheckBox->SetValue(true); 
	localizationOptionsSizer->Add( showUncertaintyEllipseCheckBox, 0, wxALL, 5 );
	
	showParticlesCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_PARTICLES, wxT("Show Particles"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	clearPosesButton = new wxButton( localMetricScrollWindow, ID_CLEAR_POSES_BUTTON, wxT("Clear Poses"), wxDefaultPosition, wxDefaultSize, 0 );
	cleanButtonsSizer->Add( clearPosesButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	clearMotionButton = new wxButton( localMetricScrollWindow, ID_CLEAR_MOTION_BUTTON, wxT("Clear Motion"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showGlassIntensityCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_GLASS_INTENSITY_BOX, wxT("Show Glass Intensity"), wxDefaultPosition, wxDefaultSize, 0 );
	glassMapOptionsSizer->Add( showGlassIntensityCheckBox, 0, wxALL, 5 );
	
	showGlassWallsCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_GLASS_WALLS_BOX, wxT("Show Glass Walls"), wxDefaultPosition, wxDefaultSize, 0 );
	glassMapOptionsSizer->Add( showGlassWallsCheckBox, 0, wxALL, 5 );
	
	showGlassAnglesCheckBox = new wxCheckBox( localMetricScrollWindow, ID_SHOW_GLASS_ANGLES_BOX, wxT("Show Glass Angles"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	glassAnglesToShowRadio = new wxRadioBox( localMetricScrollWindow, ID_GLASS_ANGLES_TO_SHOW_RADIO, wxT("Angles to Show"), wxDefaultPosition, wxDefaultSize, glassAnglesToShowRadioNChoices, glassAnglesToShowRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	flattenThreshLabel = new wxStaticText( localMetricScrollWindow, wxID_ANY, wxT("Flatten:"), wxDefaultPosition, wxDefaultSize, 0 );
	flattenThreshLabel->Wrap( -1 );
	glassSidersSizer->Add( flattenThreshLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	glassFlattenThreshSlider = new wxSlider( localMetricScrollWindow, wxID_ANY, 2, 1, 25, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS );
	glassSidersSizer->Add( glassFlattenThreshSlider, 1, wxALL|wxEXPAND, 5 );
	
	highlyVisibleGlassThreshLabel = new wxStaticText( localMetricScrollWindow, wxID_ANY, wxT("Highly-visible:"), wxDefaultPosition, wxDefaultSize, 0 );
	highlyVisibleGlassThreshLabel->Wrap( -1 );
	glassSidersSizer->Add( highlyVisibleGlassThreshLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	glassHighlyVisibleThreshSlider = new wxSlider( localMetricScrollWindow, wxID_ANY, 10, 5, 100, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS );
	...
	runFlattenMapButton = new wxButton( localMetricScrollWindow, ID_RUN_FLATTEN_MAP_BUTTON, wxT("Run Flatten Map"), wxDefaultPosition, wxDefaultSize, 0 );
	glassMapOptionsSizer->Add( runFlattenMapButton, 0, wxALL|wxEXPAND, 5 );
	
	runDynamicFilterButton = new wxButton( localMetricScrollWindow, ID_RUN_DYNAMIC_FILTER_BUTTON, wxT("Run Dynamic Filter"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	rotateLPMText = new wxTextCtrl( localMetricScrollWindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	rotateLPMText->SetMaxLength( 5 ); 
	rotateSizer->Add( rotateLPMText, 0, wxALIGN_CENTER|wxALL, 5 );
	
	rotateLPMButton = new wxButton( localMetricScrollWindow, ID_ROTATE_LPM_BUTTON, wxT("Rotate"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showRobotCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_ROBOT_POSE_CHECKBOX, wxT("Robot"), wxDefaultPosition, wxDefaultSize, 0 );
	showRobotCheckBox->SetValue(true); 
	displayOptionsGridSizer->Add( showRobotCheckBox, 0, wxALL, 5 );
	
	showTrackedObjectsCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_TRACKED_OBJECTS_CHECKBOX, wxT("Tracked Objects"), wxDefaultPosition, wxDefaultSize, 0 );
	showTrackedObjectsCheckBox->SetValue(true); 
	displayOptionsGridSizer->Add( showTrackedObjectsCheckBox, 0, wxALL, 5 );
	
	showDestinationPoseCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_DESTINATION_POSE_CHECKBOX, wxT("Destination"), wxDefaultPosition, wxDefaultSize, 0 );
	showDestinationPoseCheckBox->SetValue(true); 
	displayOptionsGridSizer->Add( showDestinationPoseCheckBox, 0, wxALL, 5 );
	
	showObjectsMotionCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_OBJECTS_MOTION_CHECKBOX, wxT("Estimated Objects Motion"), wxDefaultPosition, wxDefaultSize, 0 );
	showObjectsMotionCheckBox->SetValue(true); 
	displayOptionsGridSizer->Add( showObjectsMotionCheckBox, 0, wxALL, 5 );
	
	showOptimalPathCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_OPTIMAL_PATH_CHECKBOX, wxT("Optimal Path"), wxDefaultPosition, wxDefaultSize, 0 );
	displayOptionsGridSizer->Add( showOptimalPathCheckBox, 0, wxALL|wxEXPAND, 5 );
	
	showVisibilityAnalysisCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_VISIBILITY_ANALYSIS_CHECKBOX, wxT("Visibility Analysis"), wxDefaultPosition, wxDefaultSize, 0 );
	displayOptionsGridSizer->Add( showVisibilityAnalysisCheckBox, 0, wxALL, 5 );
	
	showSituationsCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_SITUATIONS_CHECKBOX, wxT("Situations"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	selectDestinationPoseButton = new wxButton( metricPlannerScrollWindow, ID_SELECT_DESTINATION_POSE_BUTTON, wxT("Select"), wxDefaultPosition, wxDefaultSize, 0 );
	destinationPoseSizer->Add( selectDestinationPoseButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	sendDestinationPoseButton = new wxButton( metricPlannerScrollWindow, ID_SEND_DESTINATION_POSE_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	destinationPoseSizer->Add( sendDestinationPoseButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	cancelDestinationPoseButton = new wxButton( metricPlannerScrollWindow, ID_CANCEL_DESTINATION_POSE_BUTTON, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	metricScriptFileText = new wxTextCtrl( metricPlannerScrollWindow, wxID_ANY, wxT("Enter script name"), wxDefaultPosition, wxDefaultSize, 0 );
	metricScriptSelectionSizer->Add( metricScriptFileText, 1, wxALL|wxEXPAND, 5 );
	
	metricLoadScriptButton = new wxButton( metricPlannerScrollWindow, ID_METRIC_LOAD_SCRIPT_BUTTON, wxT("Load Script"), wxDefaultPosition, wxDefaultSize, 0 );
	metricScriptSelectionSizer->Add( metricLoadScriptButton, 0, wxALL|wxEXPAND, 5 );
	
	sendWaypointsButton = new wxButton( metricPlannerScrollWindow, ID_SEND_WAYPOINTS_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	metricScriptSelectionSizer->Add( sendWaypointsButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	skipWaypointButton = new wxButton( metricPlannerScrollWindow, ID_SKIP_WAYPOINT_BUTTON, wxT("Skip"), wxDefaultPosition, wxDefaultSize, 0 );
	metricScriptSelectionSizer->Add( skipWaypointButton, 0, wxALL|wxEXPAND, 5 );
	
	cancelFollowingButton = new wxButton( metricPlannerScrollWindow, ID_CANCEL_FOLLOWING_BUTTON, wxT("Stop/Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
	metricScriptSelectionSizer->Add( cancelFollowingButton, 0, wxALL|wxEXPAND, 5 );
	
	loopWaypointsButton = new wxButton( metricPlannerScrollWindow, ID_LOOP_WAYPOINTS_BUTTON, wxT("Loop"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	selectMapTypeRadioBox = new wxRadioBox( metricPlannerScrollWindow, ID_SELECT_MAP_TYPE_RADIOBOX, wxT("Map Type"), wxDefaultPosition, wxDefaultSize, selectMapTypeRadioBoxNChoices, selectMapTypeRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	...
	selectTrjGroupRadioBox = new wxRadioBox( metricPlannerScrollWindow, ID_SELECT_TRJ_GROUP_RADIOBOX, wxT("Trajectory Type"), wxDefaultPosition, wxDefaultSize, selectTrjGroupRadioBoxNChoices, selectTrjGroupRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	...
	trjCostChoiceLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("Cost Type Displayed:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	trajectoryCostChoice = new wxChoice( metricPlannerScrollWindow, ID_SELECT_TRJ_COST_CHOICE, wxDefaultPosition, wxDefaultSize, trajectoryCostChoiceChoices, 0 );
	...
	trjDisplayModeRadioBox = new wxRadioBox( metricPlannerScrollWindow, ID_SELECT_TRJ_DISPLAY_MODE_RADIOBOX, wxT("Trajectories Displayed"), wxDefaultPosition, wxDefaultSize, trjDisplayModeRadioBoxNChoices, trjDisplayModeRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	trjDisplayModeRadioBox->SetSelection( 0 );
	mpepcGridBag->Add( trjDisplayModeRadioBox, wxGBPosition( 2, 0 ), wxGBSpan( 3, 1 ), wxALL, 5 );
	
	trajectoryCountLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("Total Count (Current): 0"), wxDefaultPosition, wxDefaultSize, 0 );
	trajectoryCountLabel->Wrap( -1 );
	mpepcGridBag->Add( trajectoryCountLabel, wxGBPosition( 2, 1 ), wxGBSpan( 1, 2 ), wxALIGN_LEFT|wxALL, 5 );
	
	numTrajectoriesText = new wxTextCtrl( metricPlannerScrollWindow, ID_CHANGE_TRJ_NUM_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER|wxTE_RIGHT );
	...
	decreaseTrajectoriesButton = new wxButton( metricPlannerScrollWindow, ID_DECREASE_TRJ_NUM_BUTTON, wxT("<"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	mpepcGridBag->Add( decreaseTrajectoriesButton, wxGBPosition( 4, 1 ), wxGBSpan( 1, 1 ), wxALL, 5 );
	
	increaseTrajectoriesButton = new wxButton( metricPlannerScrollWindow, ID_INCREASE_TRJ_NUM_BUTTON, wxT(">"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	trajectoryDisplayOptionsSizer = new wxStaticBoxSizer( new wxStaticBox( metricPlannerScrollWindow, wxID_ANY, wxT("Display Options") ), wxVERTICAL );
	
	showMotionTargetCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_MOTION_TARGETS_CHECKBOX, wxT("Motion Targets"), wxDefaultPosition, wxDefaultSize, 0 );
	trajectoryDisplayOptionsSizer->Add( showMotionTargetCheckBox, 0, wxALL, 5 );
	
	overlayRobotPosesCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_OVERLAY_ROBOT_POSES_CHECKBOX, wxT("Overlay Pose"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	evaluatedCostLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("Evaluated Cost (Single)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	evaluatedCostText = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionTargetRLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT(" r:"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetRLabel->Wrap( -1 );
	motionTargetCoordsSizer->Add( motionTargetRLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetRText = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_R_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetRText->SetMaxSize( wxSize( 80,-1 ) );
	
	motionTargetCoordsSizer->Add( motionTargetRText, 0, wxALL, 5 );
	
	motionTargetThetaLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("θ:   "), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetThetaLabel->Wrap( -1 );
	motionTargetCoordsSizer->Add( motionTargetThetaLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetThetaText = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_THETA_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionTargetDeltaLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("δ:  "), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetDeltaLabel->Wrap( -1 );
	motionTargetCoordsSizer->Add( motionTargetDeltaLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetDeltaText = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_DELTA_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionTargetGainLabel = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT(" v:"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetGainLabel->Wrap( -1 );
	motionTargetGainsSizer->Add( motionTargetGainLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetGainText = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_GAIN_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetGainText->SetMaxSize( wxSize( 80,-1 ) );
	
	motionTargetGainsSizer->Add( motionTargetGainText, 0, wxALL, 5 );
	
	motionTargetK1Label = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("k1:"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetK1Label->Wrap( -1 );
	motionTargetGainsSizer->Add( motionTargetK1Label, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetK1Text = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_K1_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetK1Text->SetMaxSize( wxSize( 80,-1 ) );
	
	motionTargetGainsSizer->Add( motionTargetK1Text, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	motionTargetK2Label = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("k2:"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetK2Label->Wrap( -1 );
	motionTargetGainsSizer->Add( motionTargetK2Label, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );
	
	motionTargetK2Text = new wxTextCtrl( metricPlannerScrollWindow, ID_MOTION_TARGET_K2_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionTargetCostText = new wxStaticText( metricPlannerScrollWindow, wxID_ANY, wxT("Evaluated Expected Cost: 0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionTargetSizer = new wxStaticBoxSizer( new wxStaticBox( metricPlannerScrollWindow, wxID_ANY, wxT("Evaluate Motion Target") ), wxHORIZONTAL );
	
	selectMotionTargetButton = new wxButton( metricPlannerScrollWindow, ID_SELECT_MOTION_TARGET_BUTTON, wxT("Select"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetSizer->Add( selectMotionTargetButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	evaluateMotionTargetButton = new wxButton( metricPlannerScrollWindow, ID_EVALUATE_MOTION_TARGET_BUTTON, wxT("Evaluate"), wxDefaultPosition, wxDefaultSize, 0 );
	motionTargetSizer->Add( evaluateMotionTargetButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	clearMotionTargetButton = new wxButton( metricPlannerScrollWindow, ID_CLEAR_MOTION_TARGET_BUTTON, wxT("Clear"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showWaypointsCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_WAYPOINTS_BOX, wxT("Show Waypoints"), wxDefaultPosition, wxDefaultSize, 0 );
	showWaypointsCheckBox->SetValue(true); 
	pathFollowingDisplayOptionsSizer->Add( showWaypointsCheckBox, 0, wxALL, 5 );
	
	useRRTStarCheckBOx = new wxCheckBox( metricPlannerScrollWindow, ID_USE_RRT_STAR_BOX, wxT("Use RRT*"), wxDefaultPosition, wxDefaultSize, 0 );
	pathFollowingDisplayOptionsSizer->Add( useRRTStarCheckBOx, 0, wxALL, 5 );
	
	stopAtWaypointsCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_STOP_AT_WAYPOINTS_BOX, wxT("Stop at Waypoint"), wxDefaultPosition, wxDefaultSize, 0 );
	stopAtWaypointsCheckBox->SetValue(true); 
	pathFollowingDisplayOptionsSizer->Add( stopAtWaypointsCheckBox, 0, wxALL, 5 );
	
	showGraphCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SHOW_GRAPH_BOX, wxT("Show Graph"), wxDefaultPosition, wxDefaultSize, 0 );
	pathFollowingDisplayOptionsSizer->Add( showGraphCheckBox, 0, wxALL, 5 );
	
	SimpleFollowingCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_SIMPLE_FOLLOWING_BOX, wxT("Simple Following"), wxDefaultPosition, wxDefaultSize, 0 );
	pathFollowingDisplayOptionsSizer->Add( SimpleFollowingCheckBox, 0, wxALL, 5 );
	
	ignoreObjectSpeedCheckBox = new wxCheckBox( metricPlannerScrollWindow, ID_IGNORE_OBJECT_SPEED_BOX, wxT("Ignore Object Speed"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	updatePlanTimeText = new wxTextCtrl( metricPlannerScrollWindow, ID_UPDATE_PLAN_TIME_TEXT, wxT("500"), wxDefaultPosition, wxSize( -1,-1 ), wxTE_RIGHT );
	updatePlanTimeText->SetMaxLength( 0 ); 
	pathPlanningOptionsSizer->Add( updatePlanTimeText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	updateWaypointsButton = new wxButton( metricPlannerScrollWindow, ID_UPDATE_WAYPOINTS_BUTTON, wxT("Update (ms)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showLaserObjectsCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_LASER_OBJECTS_BOX, wxT("Show Laser Objects"), wxDefaultPosition, wxDefaultSize, 0 );
	showLaserObjectsCheckbox->SetValue(true); 
	laserObjectOptionsSizer->Add( showLaserObjectsCheckbox, 0, wxALL|wxEXPAND, 5 );
	
	showLaserObjectPointsCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_LASER_OBJECT_POINTS_BOX, wxT("Show Laser Points"), wxDefaultPosition, wxDefaultSize, 0 );
	showLaserObjectPointsCheckbox->SetValue(true); 
	laserObjectOptionsSizer->Add( showLaserObjectPointsCheckbox, 0, wxALL|wxEXPAND, 5 );
	
	showLaserUncertaintyCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_LASER_UNCERTAINTY_BOX, wxT("Show Laser Uncertainty"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	laserObjBoundaryRadio = new wxRadioBox( trackerPanelScrollWindow, ID_LASER_OBJ_BOUNDARY_RADIO, wxT("Boundary:"), wxDefaultPosition, wxDefaultSize, laserObjBoundaryRadioNChoices, laserObjBoundaryRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	showTrackedObjectsCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_TRACKED_OBJECTS_BOX, wxT("Show Tracked Objects"), wxDefaultPosition, wxDefaultSize, 0 );
	showTrackedObjectsCheckbox->SetValue(true); 
	trackedObjectOptionsSizer->Add( showTrackedObjectsCheckbox, 0, wxALL|wxEXPAND, 5 );
	
	showTrackedAcclerationCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_TRACKED_ACCELERATION_BOX, wxT("Show Acceleration"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	rigidObjectStateRadio = new wxRadioBox( trackerPanelScrollWindow, ID_RIGID_OBJECT_STATE_RADIO, wxT("Rigid Object State"), wxDefaultPosition, wxDefaultSize, rigidObjectStateRadioNChoices, rigidObjectStateRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	trackingUncertaintyRadio = new wxRadioBox( trackerPanelScrollWindow, ID_TRACKING_UNCERTAINTY_RADIO, wxT("Uncertainty to Show"), wxDefaultPosition, wxDefaultSize, trackingUncertaintyRadioNChoices, trackingUncertaintyRadioChoices, 1, wxRA_SPECIFY_COLS );
	trackingUncertaintyRadio->SetSelection( 0 );
	trackedObjectOptionsSizer->Add( trackingUncertaintyRadio, 0, wxALL|wxEXPAND, 5 );
	
	showRecentObjectTrajectoryCheckbox = new wxCheckBox( trackerPanelScrollWindow, ID_SHOW_RECENT_OBJECT_TRAJECTORY_BOX, wxT("Show Recent Trajectory"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	objectGoalsToShowRadio = new wxRadioBox( trackerPanelScrollWindow, ID_OBJECT_GOALS_TO_SHOW_RADIO, wxT("Goals to Show"), wxDefaultPosition, wxDefaultSize, objectGoalsToShowRadioNChoices, objectGoalsToShowRadioChoices, 1, wxRA_SPECIFY_COLS );
	objectGoalsToShowRadio->SetSelection( 2 );
	objectGoalsOptionsSizer->Add( objectGoalsToShowRadio, 0, wxALL|wxEXPAND, 5 );
	
	evaluateObjectGoalsButton = new wxToggleButton( trackerPanelScrollWindow, ID_EVALUATE_OBJECT_GOALS_BUTTON, wxT("Evaluate"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	motionPredictionsToShowRadio = new wxRadioBox( trackerPanelScrollWindow, ID_MOTION_PREDICTIONS_TO_SHOW_RADIO, wxT("Prediction to Show"), wxDefaultPosition, wxDefaultSize, motionPredictionsToShowRadioNChoices, motionPredictionsToShowRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	predictionDurationLabel = new wxStaticText( trackerPanelScrollWindow, wxID_ANY, wxT("Duration (ms):"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	predictionDurationText = new wxTextCtrl( trackerPanelScrollWindow, wxID_ANY, wxT("5000"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showVoronoiGridCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_VORONOI_GRID_BOX, wxT("Show Voronoi Grid"), wxDefaultPosition, wxDefaultSize, 0 );
	showVoronoiGridCheckbox->SetValue(true); 
	placeGridOptionsSizer->Add( showVoronoiGridCheckbox, 0, wxALL|wxEXPAND, 5 );
	
	showDistanceGradientCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_DISTANCE_GRADIENT_BOX, wxT("Show Distance Gradient"), wxDefaultPosition, wxDefaultSize, 0 );
	placeGridOptionsSizer->Add( showDistanceGradientCheckBox, 0, wxALL|wxEXPAND, 5 );
	
	showFullSkeletonCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_FULL_SKELETON_BOX, wxT("Show Full Skeleton"), wxDefaultPosition, wxDefaultSize, 0 );
	placeGridOptionsSizer->Add( showFullSkeletonCheckBox, 0, wxALL, 5 );
	
	showReducedSkeletonCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_REDUCED_SKELETON_BOX, wxT("Show Reduced Skeleton"), wxDefaultPosition, wxDefaultSize, 0 );
	showReducedSkeletonCheckBox->SetValue(true); 
	placeGridOptionsSizer->Add( showReducedSkeletonCheckBox, 0, wxALL, 5 );
	
	followRobotTopoCheckBox = new wxCheckBox( localTopoScrollWindow, ID_FOLLOW_ROBOT_TOPO_BOX, wxT("Center on Robot"), wxDefaultPosition, wxDefaultSize, 0 );
	followRobotTopoCheckBox->SetValue(true); 
	placeGridOptionsSizer->Add( followRobotTopoCheckBox, 0, wxALL, 5 );
	
	showFrontiersCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_FRONTIERS_BOX, wxT("Show Frontiers"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showGatewaysCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_GATEWAYS_BOX, wxT("Show Gateways"), wxDefaultPosition, wxDefaultSize, 0 );
	gatewayOptionsSizer->Add( showGatewaysCheckBox, 0, wxALL, 5 );
	
	wxArrayString gatewayTypeChoiceChoices;
	gatewayTypeChoice = new wxChoice( localTopoScrollWindow, ID_GATEWAY_TYPE_CHOICE, wxDefaultPosition, wxDefaultSize, gatewayTypeChoiceChoices, 0 );
	gatewayTypeChoice->SetSelection( 0 );
	gatewayOptionsSizer->Add( gatewayTypeChoice, 0, wxALL|wxEXPAND, 5 );
	
	showNormalsCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_NORMALS_BOX, wxT("Show Normals"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showAreasRadioBox = new wxRadioBox( localTopoScrollWindow, ID_SHOW_AREAS_BOX, wxT("Areas To Show"), wxDefaultPosition, wxDefaultSize, showAreasRadioBoxNChoices, showAreasRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	showAreasRadioBox->SetSelection( 0 );
	areaOptionsSizer->Add( showAreasRadioBox, 0, wxALL|wxEXPAND, 5 );
	
	saveLocalTopoMapButton = new wxButton( localTopoScrollWindow, ID_SAVE_LOCAL_TOPO_MAP_BUTTON, wxT("Save Local Topo Map"), wxDefaultPosition, wxDefaultSize, 0 );
	areaOptionsSizer->Add( saveLocalTopoMapButton, 0, wxALL|wxEXPAND, 5 );
	
	loadLocalTopoMapButton = new wxButton( localTopoScrollWindow, ID_LOAD_LOCAL_TOPO_MAP_BUTTON, wxT("Load Local Topo Map"), wxDefaultPosition, wxDefaultSize, 0 );
	areaOptionsSizer->Add( loadLocalTopoMapButton, 0, wxALL|wxEXPAND, 5 );
	
	sendLocalTopoMapButton = new wxButton( localTopoScrollWindow, ID_SEND_LOCAL_TOPO_MAP_BUTTON, wxT("Send Local Topo Map"), wxDefaultPosition, wxDefaultSize, 0 );
	areaOptionsSizer->Add( sendLocalTopoMapButton, 0, wxALL|wxEXPAND, 5 );
	
	showSmallStarCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_SMALL_STAR_BOX, wxT("Show Small-Scale Star"), wxDefaultPosition, wxDefaultSize, 0 );
	areaOptionsSizer->Add( showSmallStarCheckBox, 0, wxALL, 5 );
	
	showAreaGatewaysCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_AREA_GATEWAYS_BOX, wxT("Show Area Gateways"), wxDefaultPosition, wxDefaultSize, 0 );
	areaOptionsSizer->Add( showAreaGatewaysCheckBox, 0, wxALL, 5 );
	
	showAreaGraphCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_AREA_GRAPH_BOX, wxT("Show Area Graph"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	areaHypothesisValueRadio = new wxRadioBox( localTopoScrollWindow, ID_AREA_HYPOTHESIS_VALUE_RADIO, wxT("Displayed Value"), wxDefaultPosition, wxDefaultSize, areaHypothesisValueRadioNChoices, areaHypothesisValueRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	hypFeatureLabel = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("Hypothesis Feature:"), wxDefaultPosition, wxDefaultSize, 0 );
	hypFeatureLabel->Wrap( -1 );
	hypFeatureSizer->Add( hypFeatureLabel, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	hypFeatureValueText = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("0.0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	hypFeatureChoice = new wxChoice( localTopoScrollWindow, ID_HYP_FEATURE_CHOICE, wxDefaultPosition, wxDefaultSize, hypFeatureChoiceChoices, 0 );
	...
	hypothesesToShowRadio = new wxRadioBox( localTopoScrollWindow, ID_HYPOTHESES_TO_SHOW_RADIO, wxT("Hypotheses to Show"), wxDefaultPosition, wxDefaultSize, hypothesesToShowRadioNChoices, hypothesesToShowRadioChoices, 1, wxRA_SPECIFY_COLS );
	hypothesesToShowRadio->SetSelection( 0 );
	areaOptionsSizer->Add( hypothesesToShowRadio, 0, wxALL|wxEXPAND, 5 );
	
	labelDistributionText = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("0 0 0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	labelingCSPSizer = new wxStaticBoxSizer( new wxStaticBox( localTopoScrollWindow, wxID_ANY, wxT("CSP Options") ), wxVERTICAL );
	
	cspLoadButton = new wxButton( localTopoScrollWindow, ID_CSP_LOAD_BUTTON, wxT("Load CSP Info"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	cspPlayButton = new wxButton( localTopoScrollWindow, ID_CSP_PLAY_BUTTON, wxT("Play"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	cspControlButtonSizer->Add( cspPlayButton, 0, wxALL|wxEXPAND, 5 );
	
	cspPauseButton = new wxButton( localTopoScrollWindow, ID_CSP_PAUSE_BUTTON, wxT("Pause"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	cspControlButtonSizer->Add( cspPauseButton, 0, wxALL|wxEXPAND, 5 );
	
	cspStopButton = new wxButton( localTopoScrollWindow, ID_CSP_STOP_BUTTON, wxT("Stop"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	cspJumpToStartButton = new wxButton( localTopoScrollWindow, ID_CSP_JUMP_TO_START_BUTTON, wxT("<<"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	cspIterationControlSizer->Add( cspJumpToStartButton, 0, wxALL|wxEXPAND, 5 );
	
	cspPrevIterationButton = new wxButton( localTopoScrollWindow, ID_CSP_PREV_ITERATION_BUTTON, wxT(" <"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	cspIterationControlSizer->Add( cspPrevIterationButton, 0, wxALL|wxEXPAND, 5 );
	
	cspNextIterationButton = new wxButton( localTopoScrollWindow, ID_CSP_NEXT_ITERATION_BUTTON, wxT("> "), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	cspIterationControlSizer->Add( cspNextIterationButton, 0, wxALL|wxEXPAND, 5 );
	
	cspJumpToEndButton = new wxButton( localTopoScrollWindow, ID_CSP_JUMP_TO_END_BUTTON, wxT(">>"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	cspIterationSlider = new wxSlider( localTopoScrollWindow, ID_CSP_ITERATION_SLIDER, 50, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	...
	cspSpeedSlider = new wxSlider( localTopoScrollWindow, ID_CSP_SPEED_SLIDER, 10, 1, 100, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS );
	...
	localTopoHeatmapSizer = new wxStaticBoxSizer( new wxStaticBox( localTopoScrollWindow, wxID_ANY, wxT("Heat Map Options") ), wxVERTICAL );
	
	showLocalHeatMapCheckBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_LOCAL_HEAT_MAP_BOX, wxT("Show Heat Map"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	numPathsHeatMapLabel = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("Num Paths:"), wxDefaultPosition, wxDefaultSize, 0 );
	numPathsHeatMapLabel->Wrap( -1 );
	numHeatMapPathsSizer->Add( numPathsHeatMapLabel, 0, wxALL, 5 );
	
	numHeatMapPathsText = new wxTextCtrl( localTopoScrollWindow, wxID_ANY, wxT("10000"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	generateLocalHeatMapButton = new wxButton( localTopoScrollWindow, ID_GENERATE_LOCAL_HEAT_MAP_BUTTON, wxT("Generate Heat Map"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	localTopoEventList = new wxListBox( localTopoScrollWindow, ID_LOCAL_TOPO_EVENT_LIST, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_ALWAYS_SB|wxLB_SINGLE );
	...
	showLocalTopoEventCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_LOCAL_TOPO_EVENT_BOX, wxT("Show Event Visualization"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showIsovistBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_ISOVIST_BOX, wxT("Show Isovist"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( showIsovistBox, 0, wxALL, 5 );
	
	showIsovistFieldBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_ISOVIST_FIELD_BOX, wxT("Show Isovist Field"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( showIsovistFieldBox, 0, wxALL, 5 );
	
	showIsovistFieldDerivBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_ISOVIST_DERIV_FIELD_BOX, wxT("Show Isovist Deriv Field"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	isovistLocationRadio = new wxRadioBox( localTopoScrollWindow, wxID_ANY, wxT("Location"), wxDefaultPosition, wxDefaultSize, isovistLocationRadioNChoices, isovistLocationRadioChoices, 1, wxRA_SPECIFY_COLS );
	isovistLocationRadio->SetSelection( 2 );
	isovistOptionsSizer->Add( isovistLocationRadio, 0, wxALL|wxEXPAND, 5 );
	
	calculateIsovistsButton = new wxButton( localTopoScrollWindow, ID_CALCULATE_ISOVISTS_BUTTON, wxT("Calculate"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( calculateIsovistsButton, 0, wxALL|wxEXPAND, 5 );
	
	selectIsovistsButton = new wxToggleButton( localTopoScrollWindow, ID_SELECT_ISOVISTS_BUTTON, wxT("Select Isovists"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scalarChoiceLabel = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("Scalar:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	fieldScalarChoice = new wxChoice( localTopoScrollWindow, ID_FIELD_SCALAR_CHOICE, wxDefaultPosition, wxDefaultSize, fieldScalarChoiceChoices, 0 );
	...
	calculateGradientsButton = new wxButton( localTopoScrollWindow, ID_CALCULATE_GRADIENTS_BUTTON, wxT("Calculate Gradients"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( calculateGradientsButton, 0, wxALL|wxEXPAND, 5 );
	
	showCellGradientsCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_CELL_GRADIENTS_BOX, wxT("Show Cell Gradients"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( showCellGradientsCheckbox, 0, wxALL, 5 );
	
	showIsovistMaximaCheckbox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_ISOVIST_MAXIMA_BOX, wxT("Show Gradient Maxima"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( showIsovistMaximaCheckbox, 0, wxALL, 5 );
	
	loadGatewayClassifierButton = new wxButton( localTopoScrollWindow, ID_LOAD_GATEWAY_CLASSIFIER_BUTTON, wxT("Load Gateway Classifier"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( loadGatewayClassifierButton, 0, wxALL|wxEXPAND, 5 );
	
	calculateGatewayProbabilityButton = new wxButton( localTopoScrollWindow, ID_CALCULATE_GATEWAY_PROBABILITIES_BUTTON, wxT("Calculate Probabilities"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( calculateGatewayProbabilityButton, 0, wxALL|wxEXPAND, 5 );
	
	showGatewayProbabilitiesBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_GATEWAY_PROBABILITIES_BOX, wxT("Show Probabilities"), wxDefaultPosition, wxDefaultSize, 0 );
	isovistOptionsSizer->Add( showGatewayProbabilitiesBox, 0, wxALL|wxEXPAND, 5 );
	
	gatewayProbCutoffLabel = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("Probability Cutoff:"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	gatewayProbCutoffLabel->Wrap( -1 );
	isovistOptionsSizer->Add( gatewayProbCutoffLabel, 0, wxALL|wxEXPAND, 5 );
	
	gatewayCutoffSlider = new wxSlider( localTopoScrollWindow, ID_GATEWAY_CUTOFF_SLIDER, 50, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	...
	gatewayClassifierRadio = new wxRadioBox( localTopoScrollWindow, wxID_ANY, wxT("Gateway Classifier To Use:"), wxDefaultPosition, wxDefaultSize, gatewayClassifierRadioNChoices, gatewayClassifierRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	showVisibilityGraphBox = new wxCheckBox( localTopoScrollWindow, ID_SHOW_VISIBILITY_GRAPH_BOX, wxT("Show Visibility Graph"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	visibilityFeatureChoiceLabel = new wxStaticText( localTopoScrollWindow, wxID_ANY, wxT("Feature:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	visibilityFeatureChoice = new wxChoice( localTopoScrollWindow, ID_VISIBILITY_FEATURE_CHOICE, wxDefaultPosition, wxDefaultSize, visibilityFeatureChoiceChoices, 0 );
	...
	globalTopoMapViewRadioBox = new wxRadioBox( globalTopoScrolledWindow, ID_GLOBAL_TOPO_MAP_VIEW_RADIO_BOX, wxT("Map View"), wxDefaultPosition, wxDefaultSize, globalTopoMapViewRadioBoxNChoices, globalTopoMapViewRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	...
	activeHypothesesText = new wxStaticText( globalTopoScrolledWindow, wxID_ANY, wxT("Num Leaves:"), wxDefaultPosition, wxDefaultSize, 0 );
	activeHypothesesText->Wrap( -1 );
	numHypothesesSizer->Add( activeHypothesesText, 0, wxALL, 5 );
	
	numActiveHypothesesLabel = new wxStaticText( globalTopoScrolledWindow, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	numActiveHypothesesLabel->Wrap( -1 );
	numHypothesesSizer->Add( numActiveHypothesesLabel, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	numCompleteHypothesesText = new wxStaticText( globalTopoScrolledWindow, wxID_ANY, wxT("Num Complete:"), wxDefaultPosition, wxDefaultSize, 0 );
	numCompleteHypothesesText->Wrap( -1 );
	numHypothesesSizer->Add( numCompleteHypothesesText, 0, wxALL, 5 );
	
	numCompleteHypothesesLabel = new wxStaticText( globalTopoScrolledWindow, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showBestTopoMapCheckBox = new wxCheckBox( globalTopoScrolledWindow, ID_SHOW_BEST_TOPO_MAP_CHECK_BOX, wxT("Show Best Map"), wxDefaultPosition, wxDefaultSize, 0 );
	globalTopologyOptionsSizer->Add( showBestTopoMapCheckBox, 0, wxALL, 5 );
	
	mapToShowLabel = new wxStaticText( globalTopoScrolledWindow, wxID_ANY, wxT("Map To Show:"), wxDefaultPosition, wxDefaultSize, 0 );
	mapToShowLabel->Wrap( -1 );
	globalTopologyOptionsSizer->Add( mapToShowLabel, 0, wxALL, 5 );
	
	topoHypothesisComboBox = new wxComboBox( globalTopoScrolledWindow, ID_TOPO_HYPOTHESIS_COMBO_BOX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_DROPDOWN ); 
	...
	previousHypothesisButton = new wxButton( globalTopoScrolledWindow, ID_PREVIOUS_HYPOTHESIS_BUTTON, wxT("Prev"), wxDefaultPosition, wxDefaultSize, 0 );
	switchMapsSizer->Add( previousHypothesisButton, 0, wxALL, 5 );
	
	nextHypothesisButton = new wxButton( globalTopoScrolledWindow, ID_NEXT_HYPOTHESIS_BUTTON, wxT("Next"), wxDefaultPosition, wxDefaultSize, 0 );
	switchMapsSizer->Add( nextHypothesisButton, 0, wxALL, 5 );
	
	
	globalTopologyOptionsSizer->Add( switchMapsSizer, 0, 0, 5 );
	
	useGlobalTopoMapButton = new wxButton( globalTopoScrolledWindow, ID_USE_GLOBAL_TOPO_MAP_BUTTON, wxT("Use Current Map"), wxDefaultPosition, wxDefaultSize, 0 );
	globalTopologyOptionsSizer->Add( useGlobalTopoMapButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	loadGlobalTopoMapButton = new wxButton( globalTopoScrolledWindow, ID_LOAD_GLOBAL_TOPO_MAP_FROM_FILE_BUTTON, wxT("Load From File"), wxDefaultPosition, wxDefaultSize, 0 );
	globalTopologyOptionsSizer->Add( loadGlobalTopoMapButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	saveCurrentMapButton = new wxButton( globalTopoScrolledWindow, ID_SAVE_CURRENT_MAP_BUTTON, wxT("Save Current Map"), wxDefaultPosition, wxDefaultSize, 0 );
	globalTopologyOptionsSizer->Add( saveCurrentMapButton, 0, wxALIGN_CENTER|wxALL, 5 );
	
	wxStaticBoxSizer* treeOfMapsCommandsSizer;
	treeOfMapsCommandsSizer = new wxStaticBoxSizer( new wxStaticBox( globalTopoScrolledWindow, wxID_ANY, wxT("Tree of Maps Options") ), wxVERTICAL );
	
	wxGridSizer* treeOfMapOptionsButtonSizer;
	treeOfMapOptionsButtonSizer = new wxGridSizer( 2, 2, 0, 0 );
	
	saveTreeButton = new wxButton( globalTopoScrolledWindow, ID_SAVE_TREE_BUTTON, wxT("Save Tree"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadTreeButton = new wxButton( globalTopoScrolledWindow, ID_LOAD_TREE_BUTTON, wxT("Load Tree"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	saveMapCacheButton = new wxButton( globalTopoScrolledWindow, ID_SAVE_MAP_CACHE_BUTTON, wxT("Save Cache"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadMapCacheButton = new wxButton( globalTopoScrolledWindow, ID_LOAD_MAP_CACHE_BUTTON, wxT("Load Cache"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	hypothesisInfoSizer = new wxStaticBoxSizer( new wxStaticBox( globalTopoScrolledWindow, wxID_ANY, wxT("Hypothesis Info:") ), wxVERTICAL );
	
	hypothesisInfoGrid = new wxGrid( globalTopoScrolledWindow, ID_HYPOTHESIS_INFO_GRID, wxDefaultPosition, wxDefaultSize, 0 );
	...
	hypothesisInfoGrid->SetColLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	...
	hypothesisInfoGrid->SetRowLabelAlignment( wxALIGN_RIGHT, wxALIGN_CENTRE );
	
	// Label Appearance
	
	// Cell Defaults
	hypothesisInfoGrid->SetDefaultCellAlignment( wxALIGN_LEFT, wxALIGN_CENTRE );
	hypothesisInfoSizer->Add( hypothesisInfoGrid, 0, wxALL|wxEXPAND, 5 );
	
	
	globalTopologyOptionsSizer->Add( hypothesisInfoSizer, 0, 0, 5 );
	
	clearGlobalTopoMapsButton = new wxButton( globalTopoScrolledWindow, ID_CLEAR_GLOBAL_TOPO_MAPS_BUTTON, wxT("Clear Maps"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadEvalMapButton = new wxButton( evaluationScrollWindow, ID_LOAD_EVAL_MAP_BUTTON, wxT("Load Map"), wxDefaultPosition, wxDefaultSize, 0 );
	stabilityEvalSizer->Add( loadEvalMapButton, 0, wxALL|wxEXPAND, 5 );
	
	importStabilityLogButton = new wxButton( evaluationScrollWindow, ID_IMPORT_STABILITY_LOG_BUTTON, wxT("Import Log"), wxDefaultPosition, wxDefaultSize, 0 );
	stabilityEvalSizer->Add( importStabilityLogButton, 0, wxALL|wxEXPAND, 5 );
	
	clearStabilityEvalButton = new wxButton( evaluationScrollWindow, ID_CLEAR_STABILITY_EVAL_BUTTON, wxT("Clear All"), wxDefaultPosition, wxDefaultSize, 0 );
	stabilityEvalSizer->Add( clearStabilityEvalButton, 0, wxALL|wxEXPAND, 5 );
	
	wxStaticBoxSizer* evalRenderOptionsSizer;
	evalRenderOptionsSizer = new wxStaticBoxSizer( new wxStaticBox( evaluationScrollWindow, wxID_ANY, wxT("Rendering Options:") ), wxVERTICAL );
	
	drawEvalBoundaryBox = new wxCheckBox( evaluationScrollWindow, ID_DRAW_EVAL_BOUNDARY_BOX, wxT("Draw Boundary"), wxDefaultPosition, wxDefaultSize, 0 );
	drawEvalBoundaryBox->SetValue(true); 
	evalRenderOptionsSizer->Add( drawEvalBoundaryBox, 0, wxALL|wxEXPAND, 5 );
	
	drawEvalStarBox = new wxCheckBox( evaluationScrollWindow, ID_DRAW_EVAL_STAR_BOX, wxT("Draw Star"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadMPEPCResultsFileButton = new wxButton( evaluationScrollWindow, ID_LOAD_MPEPC_RESULTS_FILE_BUTTON, wxT("Load Results File"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	totalLocalTopoAreasLabel = new wxStaticText( explorationPanel, wxID_ANY, wxT("Total:"), wxDefaultPosition, wxDefaultSize, 0 );
	totalLocalTopoAreasLabel->Wrap( -1 );
	localTopoExplorationStatusSizer->Add( totalLocalTopoAreasLabel, 0, wxALIGN_RIGHT|wxALL, 5 );
	
	totalLocalTopoAreasText = new wxStaticText( explorationPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	totalLocalTopoAreasText->Wrap( -1 );
	localTopoExplorationStatusSizer->Add( totalLocalTopoAreasText, 0, wxALL|wxLEFT, 5 );
	
	visitedLocalTopoAreasLabel = new wxStaticText( explorationPanel, wxID_ANY, wxT("Visited:"), wxDefaultPosition, wxDefaultSize, 0 );
	visitedLocalTopoAreasLabel->Wrap( -1 );
	localTopoExplorationStatusSizer->Add( visitedLocalTopoAreasLabel, 0, wxALIGN_RIGHT|wxALL, 5 );
	
	visitedLocalTopoAreasText = new wxStaticText( explorationPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	visitedLocalTopoAreasText->Wrap( -1 );
	localTopoExplorationStatusSizer->Add( visitedLocalTopoAreasText, 0, wxALL|wxLEFT, 5 );
	
	remainingLocalTopoAreasLabel = new wxStaticText( explorationPanel, wxID_ANY, wxT("Remaining:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	remainingLocalTopoAreasText = new wxStaticText( explorationPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	relocalizeShowLaserCheckBox = new wxCheckBox( relocalizationScrollWindow, ID_RELOCALIZE_SHOW_LASER_BOX, wxT("Laser"), wxDefaultPosition, wxDefaultSize, 0 );
	relocalizeShowLaserCheckBox->SetValue(true); 
	relocalizeDataSizer->Add( relocalizeShowLaserCheckBox, 0, wxALL, 5 );
	
	relocalizeShowErrorCheckBox = new wxCheckBox( relocalizationScrollWindow, ID_RELOCALIZE_SHOW_ERROR_BOX, wxT("Error"), wxDefaultPosition, wxDefaultSize, 0 );
	relocalizeShowErrorCheckBox->SetValue(true); 
	relocalizeDataSizer->Add( relocalizeShowErrorCheckBox, 0, wxALL, 5 );
	
	relocalizeShowParticlesCheckBox = new wxCheckBox( relocalizationScrollWindow, ID_RELOCALIZE_SHOW_PARTICLES_BOX, wxT("Particles"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	regionInitializerOptionsSizer = new wxStaticBoxSizer( new wxStaticBox( relocalizationScrollWindow, wxID_ANY, wxT("Region:") ), wxVERTICAL );
	
	wxBoxSizer* regionNumSamplesSizer;
	regionNumSamplesSizer = new wxBoxSizer( wxHORIZONTAL );
	
	regionNumSamplesLabel = new wxStaticText( relocalizationScrollWindow, wxID_ANY, wxT("Num Samples:"), wxDefaultPosition, wxDefaultSize, 0 );
	regionNumSamplesLabel->Wrap( -1 );
	regionNumSamplesSizer->Add( regionNumSamplesLabel, 0, wxALIGN_CENTER|wxALL, 5 );
	
	regionNumSamplesText = new wxTextCtrl( relocalizationScrollWindow, wxID_ANY, wxT("30000"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	regionPosesPerPosLabel = new wxStaticText( relocalizationScrollWindow, wxID_ANY, wxT("Poses Per Position:"), wxDefaultPosition, wxDefaultSize, 0 );
	regionPosesPerPosLabel->Wrap( -1 );
	regionPosesPerPosSizer->Add( regionPosesPerPosLabel, 0, wxALIGN_CENTER|wxALL, 5 );
	
	regionPosesPerPositionText = new wxTextCtrl( relocalizationScrollWindow, wxID_ANY, wxT("60"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	setRegionRelocalizeButton = new wxToggleButton( relocalizationScrollWindow, ID_SET_REGION_RELOCALIZE_BUTTON, wxT("Set Region"), wxDefaultPosition, wxDefaultSize, 0 );
	setRegionRelocalizeButton->SetFont( wxFont( 12, 70, 90, 90, false, wxEmptyString ) );
	
	regionInitializerOptionsSizer->Add( setRegionRelocalizeButton, 0, wxALL|wxEXPAND, 5 );
	
	sendRegionMessageButton = new wxButton( relocalizationScrollWindow, ID_SEND_REGION_MESSAGE_BUTTON, wxT("Send Message"), wxDefaultPosition, wxDefaultSize, 0 );
	sendRegionMessageButton->SetFont( wxFont( 14, 70, 90, 90, false, wxEmptyString ) );
	...
	freeSpaceInitializerSizer = new wxStaticBoxSizer( new wxStaticBox( relocalizationScrollWindow, wxID_ANY, wxT("Free Space:") ), wxVERTICAL );
	
	wxBoxSizer* freeSpaceCellStrideSizer;
	freeSpaceCellStrideSizer = new wxBoxSizer( wxHORIZONTAL );
	
	freeSpaceCellStrideLabel = new wxStaticText( relocalizationScrollWindow, wxID_ANY, wxT("Cell Stride:"), wxDefaultPosition, wxDefaultSize, 0 );
	freeSpaceCellStrideLabel->Wrap( -1 );
	freeSpaceCellStrideSizer->Add( freeSpaceCellStrideLabel, 0, wxALIGN_CENTER|wxALL, 5 );
	
	freeSpaceCellStrideText = new wxTextCtrl( relocalizationScrollWindow, wxID_ANY, wxT("10"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	freeSpacePosesPerCellLabel = new wxStaticText( relocalizationScrollWindow, wxID_ANY, wxT("Poses Per Cell:"), wxDefaultPosition, wxDefaultSize, 0 );
	freeSpacePosesPerCellLabel->Wrap( -1 );
	freeSpacePosesPerCellSizer->Add( freeSpacePosesPerCellLabel, 0, wxALIGN_CENTER|wxALL, 5 );
	
	freeSpacePosesPerCellText = new wxTextCtrl( relocalizationScrollWindow, wxID_ANY, wxT("10"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sendFreeSpaceMessageButton = new wxButton( relocalizationScrollWindow, ID_SEND_FREE_SPACE_MESSAGE_BUTTON, wxT("Send Message"), wxDefaultPosition, wxDefaultSize, 0 );
	sendFreeSpaceMessageButton->SetFont( wxFont( 14, 70, 90, 90, false, wxEmptyString ) );
	...
	scanMatchingInitializerSizer = new wxStaticBoxSizer( new wxStaticBox( relocalizationScrollWindow, wxID_ANY, wxT("Scan Matching:") ), wxVERTICAL );
	
	sendScanMatchingMessageButton = new wxButton( relocalizationScrollWindow, ID_SEND_SCAN_MATCHING_MESSAGE_BUTTON, wxT("Send Message"), wxDefaultPosition, wxDefaultSize, 0 );
	sendScanMatchingMessageButton->SetFont( wxFont( 14, 70, 90, 90, false, wxEmptyString ) );
	...
	scriptingLoadMapButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPTING_LOAD_MAP_BUTTON, wxT("Load"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptMapOptionsSizer->Add( scriptingLoadMapButton, 0, wxALL, 5 );
	
	scriptingCaptureMapButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPTING_CAPTURE_MAP_BUTTON, wxT("Capture"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptingTargetSetList = new wxListCtrl( scriptingOptionsScrolledWindow, ID_SCRIPTING_TARGET_SET_LIST, wxDefaultPosition, wxDefaultSize, wxLC_HRULES|wxLC_REPORT|wxLC_SINGLE_SEL );
	...
	scriptTargetNameLabel = new wxStaticText( scriptingOptionsScrolledWindow, wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptTargetNameText = new wxTextCtrl( scriptingOptionsScrolledWindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	targetDescriptionSizer->Add( scriptTargetNameText, 1, wxALL|wxEXPAND, 5 );
	
	scriptTargetTypeLael = new wxStaticText( scriptingOptionsScrolledWindow, wxID_ANY, wxT("Type:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptPoseTargetButton = new wxRadioButton( scriptingOptionsScrolledWindow, ID_SCRIPT_POSE_TARGET_BUTTON, wxT("Pose"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	scriptPoseTargetButton->SetValue( true ); 
	scriptTargetTypeRadioSizer->Add( scriptPoseTargetButton, 0, wxALL, 5 );
	
	scriptElevatorTargetButton = new wxRadioButton( scriptingOptionsScrolledWindow, ID_SCRIPT_ELEVATOR_TARGET_BUTTON, wxT("Elevator"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptTargetPoseLabel = new wxStaticText( scriptingOptionsScrolledWindow, wxID_ANY, wxT("Pose:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptTargetPoseText = new wxTextCtrl( scriptingOptionsScrolledWindow, ID_SCRIPT_TARGET_POSE_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
	targetDescriptionSizer->Add( scriptTargetPoseText, 0, wxALL|wxEXPAND, 5 );
	
	scriptTargetSelectPoseButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_TARGET_SELECT_POSE_BUTTON, wxT("Select Pose"), wxDefaultPosition, wxDefaultSize, 0 );
	targetDescriptionSizer->Add( scriptTargetSelectPoseButton, 0, wxALIGN_CENTER|wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
	
	scriptTargetCurrentButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_TARGET_CURRENT_BUTTON, wxT("Current Pose"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptCreateTargetButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_CREATE_TARGET_BUTTON, wxT("Add"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetCreationSizer->Add( scriptCreateTargetButton, 0, wxALL, 5 );
	
	scriptEraseTargetButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_ERASE_TARGET_BUTTON, wxT("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetCreationSizer->Add( scriptEraseTargetButton, 0, wxALL, 5 );
	
	scriptSaveTargetsButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_SAVE_TARGETS_BUTTON, wxT("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetCreationSizer->Add( scriptSaveTargetsButton, 0, wxALL, 5 );
	
	scriptLoadTargetsButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_LOAD_TARGETS_BUTTON, wxT("Load"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	scriptTargetsList = new wxListBox( scriptingOptionsScrolledWindow, ID_SCRIPT_TARGETS_LIST, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_SINGLE ); 
	...
	scriptAddTargetButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_ADD_TARGET_BUTTON, wxT("Add"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetAdditionSizer->Add( scriptAddTargetButton, 0, wxALL, 5 );
	
	scriptRemoveTargetButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_REMOVE_TARGET_BUTTON, wxT("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetAdditionSizer->Add( scriptRemoveTargetButton, 0, wxALL, 5 );
	
	scriptSaveButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_SAVE_BUTTON, wxT("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetAdditionSizer->Add( scriptSaveButton, 0, wxALL, 5 );
	
	scriptLoadButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_LOAD_BUTTON, wxT("Load"), wxDefaultPosition, wxDefaultSize, 0 );
	scriptTargetAdditionSizer->Add( scriptLoadButton, 0, wxALL, 5 );
	
	
	scriptOptionsSizer->Add( scriptTargetAdditionSizer, 0, wxEXPAND, 5 );
	
	scriptSendButton = new wxButton( scriptingOptionsScrolledWindow, ID_SCRIPT_SEND_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	globalMetricCaptureLPMButton = new wxButton( globalMetricScrolledWindow, ID_GLOBAL_METRIC_CAPTURE_LPM_BUTTON, wxT("Capture LPM"), wxDefaultPosition, wxDefaultSize, 0 );
	globalMetricLoadOptions->Add( globalMetricCaptureLPMButton, 0, wxALL|wxEXPAND, 5 );
	
	loadLPMForGlobalMetricButton = new wxButton( globalMetricScrolledWindow, ID_LOAD_LPM_FOR_GLOBAL_METRIC_BUTTON, wxT("Load LPM"), wxDefaultPosition, wxDefaultSize, 0 );
	globalMetricLoadOptions->Add( loadLPMForGlobalMetricButton, 0, wxALL|wxEXPAND, 5 );
	
	loadGlobalMetricMapButton = new wxButton( globalMetricScrolledWindow, ID_LOAD_GLOBAL_METRIC_MAP_BUTTON, wxT("Local Global Map"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	globalMetricMapNameText = new wxTextCtrl( globalMetricScrolledWindow, ID_GLOBAL_METRIC_MAP_NAME_TEXT, wxT("Map Name"), wxDefaultPosition, wxDefaultSize, 0 );
	globalMetricSaveOptions->Add( globalMetricMapNameText, 0, wxALL|wxEXPAND, 5 );
	
	saveGlobalMapButton = new wxButton( globalMetricScrolledWindow, ID_SAVE_GLOBAL_MAP_BUTTON, wxT("Save Global Map"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	globalMetricRelocalizeButton->SetFont( wxFont( 16, 74, 90, 90, false, wxT("Sans") ) );
	...
	showFrontLaserCheckBox = new wxCheckBox( calibrationScrollWindow, ID_SHOW_FRONT_LASER_BOX, wxT("Show Front Laser"), wxDefaultPosition, wxDefaultSize, 0 );
	showFrontLaserCheckBox->SetValue(true); 
	laserOptionsFlexGridSizer->Add( showFrontLaserCheckBox, 0, wxALL, 5 );
	
	showBackLaserCheckBox = new wxCheckBox( calibrationScrollWindow, ID_SHOW_BACK_LASER_BOX, wxT("Show Back Laser"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	frontLaserCoordsXLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  x:"), wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoordsXLabel->Wrap( -1 );
	frontLaserCoords->Add( frontLaserCoordsXLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	frontLaserCoordsXText = new wxTextCtrl( calibrationScrollWindow, ID_FRONT_LASER_COORDS_X, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoords->Add( frontLaserCoordsXText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	frontLaserCoordsYLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  y:"), wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoordsYLabel->Wrap( -1 );
	frontLaserCoords->Add( frontLaserCoordsYLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	frontLaserCoordsYText = new wxTextCtrl( calibrationScrollWindow, ID_FRONT_LASER_COORDS_Y, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoords->Add( frontLaserCoordsYText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	frontLaserCoordsThetaLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  θ:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	frontLaserCoordsThetaText = new wxTextCtrl( calibrationScrollWindow, ID_FRONT_LASER_COORDS_THETA, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoords->Add( frontLaserCoordsThetaText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	frontLaserPitchLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Pitch:"), wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserPitchLabel->Wrap( -1 );
	frontLaserCoords->Add( frontLaserPitchLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	frontLaserPitchText = new wxTextCtrl( calibrationScrollWindow, ID_FRONT_LASER_PITCH_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserCoords->Add( frontLaserPitchText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	frontLaserRollLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Roll:"), wxDefaultPosition, wxDefaultSize, 0 );
	frontLaserRollLabel->Wrap( -1 );
	frontLaserCoords->Add( frontLaserRollLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	frontLaserRollText = new wxTextCtrl( calibrationScrollWindow, ID_FRONT_LASER_ROLL_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	backLaserCoordsXLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  x:"), wxDefaultPosition, wxDefaultSize, 0 );
	backLaserCoordsXLabel->Wrap( -1 );
	BackLaserCoords->Add( backLaserCoordsXLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	backLaserCoordsXText = new wxTextCtrl( calibrationScrollWindow, ID_BACK_LASER_COORDS_X, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	BackLaserCoords->Add( backLaserCoordsXText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	backLaserCoordsYLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  y:"), wxDefaultPosition, wxDefaultSize, 0 );
	backLaserCoordsYLabel->Wrap( -1 );
	BackLaserCoords->Add( backLaserCoordsYLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	backLaserCoordsYText = new wxTextCtrl( calibrationScrollWindow, ID_BACK_LASER_COORDS_Y, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	BackLaserCoords->Add( backLaserCoordsYText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	backLaserCoordsThetaLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("  θ:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	backLaserCoordsThetaText = new wxTextCtrl( calibrationScrollWindow, ID_BACK_LASER_COORDS_THETA, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	BackLaserCoords->Add( backLaserCoordsThetaText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	backLaserPitchLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Pitch:"), wxDefaultPosition, wxDefaultSize, 0 );
	backLaserPitchLabel->Wrap( -1 );
	BackLaserCoords->Add( backLaserPitchLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	backLaserPitchText = new wxTextCtrl( calibrationScrollWindow, ID_BACK_LASER_PITCH_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	BackLaserCoords->Add( backLaserPitchText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	backLaserRollLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Roll:"), wxDefaultPosition, wxDefaultSize, 0 );
	backLaserRollLabel->Wrap( -1 );
	BackLaserCoords->Add( backLaserRollLabel, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	backLaserRollText = new wxTextCtrl( calibrationScrollWindow, ID_BACK_LASER_ROLL_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	loadTiltDataButton = new wxButton( calibrationScrollWindow, ID_LOAD_TILT_DATA_BUTTON, wxT("Load Tilt Data"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	tiltLaserRadio = new wxRadioBox( calibrationScrollWindow, ID_TILT_LASER_RADIO, wxT("Laser to Calibrate:"), wxDefaultPosition, wxDefaultSize, tiltLaserRadioNChoices, tiltLaserRadioChoices, 1, wxRA_SPECIFY_COLS );
	...
	lineStartIndexLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Line start index:"), wxDefaultPosition, wxDefaultSize, 0 );
	lineStartIndexLabel->Wrap( -1 );
	lineStartIndexSizer->Add( lineStartIndexLabel, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	lineStartIndexText = new wxTextCtrl( calibrationScrollWindow, ID_LINE_START_INDEX_TEXT, wxT("-1"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lineEndIndexLabel = new wxStaticText( calibrationScrollWindow, wxID_ANY, wxT("Line end index:"), wxDefaultPosition, wxDefaultSize, 0 );
	lineEndIndexLabel->Wrap( -1 );
	lineEndIndexSizer->Add( lineEndIndexLabel, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	lineEndIndexText = new wxTextCtrl( calibrationScrollWindow, ID_LINE_END_INDEX_TEXT, wxT("-1"), wxDefaultPosition, wxDefaultSize, 0 );
	lineEndIndexSizer->Add( lineEndIndexText, 1, wxALL, 5 );
	
	
	tiltCalibrationSizer->Add( lineEndIndexSizer, 1, wxEXPAND, 5 );
	
	calibratePitchButton = new wxButton( calibrationScrollWindow, ID_CALIBRATE_PITCH_BUTTON, wxT("Calibrate Pitch"), wxDefaultPosition, wxDefaultSize, 0 );
	tiltCalibrationSizer->Add( calibratePitchButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	calibrateRollButton = new wxButton( calibrationScrollWindow, ID_CALIBRATE_ROLL_BUTTON, wxT("Calibrate Roll"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	localPlaceStateGrid = new wxGrid( decisionPlannerScrollWindow, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	...
	localPlaceStateGrid->SetColLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	...
	localPlaceStateGrid->SetRowLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	...
	localPathStateGrid = new wxGrid( decisionPlannerScrollWindow, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	...
	localPathStateGrid->SetColLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	...
	localPathStateGrid->SetRowLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	
	// Label Appearance
	
	// Cell Defaults
	localPathStateGrid->SetDefaultCellAlignment( wxALIGN_RIGHT, wxALIGN_CENTRE );
	...
	forwardTargetButton = new wxButton( decisionPlannerScrollWindow, ID_FORWARD_TARGET_BUTTON, wxT("Forward"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	leftTargetButton = new wxButton( decisionPlannerScrollWindow, ID_LEFT_TARGET_BUTTON, wxT("Left"), wxDefaultPosition, wxDefaultSize, 0 );
	leftRightTargetSizer->Add( leftTargetButton, 0, wxALIGN_RIGHT|wxALL, 5 );
	
	rightTargetButton = new wxButton( decisionPlannerScrollWindow, ID_RIGHT_TARGET_BUTTON, wxT("Right"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	backTargetButton = new wxButton( decisionPlannerScrollWindow, ID_BACK_TARGET_BUTTON, wxT("Back"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	pathTargetStartButton = new wxButton( decisionPlannerScrollWindow, ID_PATH_TARGET_START_BUTTON, wxT("Path Start"), wxDefaultPosition, wxDefaultSize, 0 );
	pathTargetSizer->Add( pathTargetStartButton, 0, wxALIGN_RIGHT|wxALL, 5 );
	
	pathTargetEndButton = new wxButton( decisionPlannerScrollWindow, ID_PATH_TARGET_END_BUTTON, wxT("Path End"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	removeRelativeTargetButton = new wxButton( decisionPlannerScrollWindow, ID_REMOVE_RELATIVE_TARGET_BUTTON, wxT("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	targetSequenceOptionsSizer->Add( removeRelativeTargetButton, 0, wxALL, 5 );
	
	clearRelativeTargetsButton = new wxButton( decisionPlannerScrollWindow, ID_CLEAR_RELATIVE_TARGETS_BUTTON, wxT("Clear"), wxDefaultPosition, wxDefaultSize, 0 );
	targetSequenceOptionsSizer->Add( clearRelativeTargetsButton, 0, wxALL, 5 );
	
	sendRelativeTargetsButton = new wxButton( decisionPlannerScrollWindow, ID_SEND_RELATIVE_TARGETS_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	setLocationButton = new wxButton( goalPlannerScrollWindow, ID_SET_LOCATION_BUTTON, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0 );
	setLocationSizer->Add( setLocationButton, 0, wxALL, 5 );
	
	sendLocationButton = new wxButton( goalPlannerScrollWindow, ID_SEND_LOCATION_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	setGoalButton = new wxButton( goalPlannerScrollWindow, ID_SET_GOAL_BUTTON, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0 );
	setGoalSizer->Add( setGoalButton, 0, wxALL, 5 );
	
	sendGoalButton = new wxButton( goalPlannerScrollWindow, ID_SEND_GOAL_BUTTON, wxT("Send"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	animateFPSText = new wxTextCtrl( goalPlannerScrollWindow, ID_ANIMATE_FPS_TEXT, wxT("15"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT );
	animateFPSText->SetMaxLength( 3 ); 
	animateSearchSizer->Add( animateFPSText, 0, wxALIGN_CENTER|wxALL, 5 );
	
	animateSearchButton = new wxButton( goalPlannerScrollWindow, ID_ANIMATE_SEARCH_BUTTON, wxT("Animate"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	confirmRouteButton = new wxButton( goalPlannerScrollWindow, ID_CONFIRM_ROUTE_BUTTON, wxT("Confirm"), wxDefaultPosition, wxDefaultSize, 0 );
	routeControlSizer->Add( confirmRouteButton, 0, wxALL, 5 );
	
	cancelRouteButton = new wxButton( goalPlannerScrollWindow, ID_CANCEL_ROUTE_BUTTON, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	showSegmentsCheckBox = new wxCheckBox( visionPanel, ID_SHOW_SEGMENTS_BOX, wxT("Show Segments"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	minEdgeWeightLabel = new wxStaticText( visionPanel, wxID_ANY, wxT("Min Edge Weight:"), wxDefaultPosition, wxDefaultSize, 0 );
	minEdgeWeightLabel->Wrap( -1 );
	segmentationOptionsSizer->Add( minEdgeWeightLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	minEdgeWeightSlider = new wxSlider( visionPanel, ID_MIN_EDGE_WEIGHT_SLIDER, 42, 0, 50, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	segmentationOptionsSizer->Add( minEdgeWeightSlider, 1, wxALL|wxEXPAND, 5 );
	
	maxEdgeWeightLabel = new wxStaticText( visionPanel, wxID_ANY, wxT("Max Edge Weight:"), wxDefaultPosition, wxDefaultSize, 0 );
	maxEdgeWeightLabel->Wrap( -1 );
	segmentationOptionsSizer->Add( maxEdgeWeightLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	maxEdgeWeightSlider = new wxSlider( visionPanel, ID_MAX_EDGE_WEIGHT_SLIDER, 21, 0, 50, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	segmentationOptionsSizer->Add( maxEdgeWeightSlider, 0, wxALL|wxEXPAND, 5 );
	
	pixelSigmaLabel = new wxStaticText( visionPanel, wxID_ANY, wxT("Pixel Sigma:"), wxDefaultPosition, wxDefaultSize, 0 );
	pixelSigmaLabel->Wrap( -1 );
	segmentationOptionsSizer->Add( pixelSigmaLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	pixelSigmaSlider = new wxSlider( visionPanel, ID_PIXEL_SIGMA_SLIDER, 20, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	segmentationOptionsSizer->Add( pixelSigmaSlider, 0, wxALL|wxEXPAND, 5 );
	
	creditMultiplierLabel = new wxStaticText( visionPanel, wxID_ANY, wxT("Credit Multiplier:"), wxDefaultPosition, wxDefaultSize, 0 );
	creditMultiplierLabel->Wrap( -1 );
	segmentationOptionsSizer->Add( creditMultiplierLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	creditMultiplierSlider = new wxSlider( visionPanel, ID_CREDIT_MULTIPLIER_SLIDER, 10, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	segmentationOptionsSizer->Add( creditMultiplierSlider, 0, wxALL|wxEXPAND, 5 );
	
	filterWidthLabel = new wxStaticText( visionPanel, wxID_ANY, wxT("Filter Width:"), wxDefaultPosition, wxDefaultSize, 0 );
	filterWidthLabel->Wrap( -1 );
	segmentationOptionsSizer->Add( filterWidthLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	filterWidthSlider = new wxSlider( visionPanel, ID_FILTER_WIDTH_SLIDER, 13, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	...
	moduleStatusGrid->SetColLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	
	// Rows
	moduleStatusGrid->EnableDragRowSize( true );
	moduleStatusGrid->SetRowLabelSize( 80 );
	moduleStatusGrid->SetRowLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );
	...
	this->Layout();
	gridCellStatusBar = this->CreateStatusBar( 1, wxST_SIZEGRIP, ID_GRID_CELL_STATUS_BAR );

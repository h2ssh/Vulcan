...
public:
    ...
    * 
    * \param    gridWidget      GridBasedDisplayWidget to be used for converting the mouse into the currently displayed grid
    */
    GridCellSelector(const GridBasedDisplayWidget* gridWidget,
                     std::size_t                   maxSelectionSize = 100000);

...
local_topo_display_params_t load_local_topo_display_params(const utils::ConfigFile& config)
{
    ...
    std::vector<std::string> fieldColors =
      utils::split_into_strings(config.getValueAsString(LOCAL_TOPO_DISPLAY_HEADING, ISOVIST_FIELD_COLORS_KEY), ';');
...
metric_planner_display_params_t load_metric_planner_display_params(const utils::ConfigFile& config)
{
    ...
    params.trajectoryColorRed =
      GLColor(config.getValueAsString(METRIC_PLANNER_DISPLAY_HEADING, TRAJECTORY_COLOR_RED_KEY));
    params.trajectoryColorBlue =
      GLColor(config.getValueAsString(METRIC_PLANNER_DISPLAY_HEADING, TRAJECTORY_COLOR_BLUE_KEY));
    params.trajectoryColorGreen =
      GLColor(config.getValueAsString(METRIC_PLANNER_DISPLAY_HEADING, TRAJECTORY_COLOR_GREEN_KEY));
    ...
    params.robotColorLightBlue =
      GLColor(config.getValueAsString(METRIC_PLANNER_DISPLAY_HEADING, ROBOT_COLOR_LIGHT_BLUE_KEY));
    ...
    params.goalRegionColor =
      GLColor(config.getValueAsString(METRIC_PLANNER_DISPLAY_HEADING, RRT_GOAL_REGION_COLOR_KEY));
...
decision_planner_display_params_t load_decision_planner_display_params(const utils::ConfigFile& config)
{
    ...
    params.targetSequenceChannel =
      config.getValueAsString(DECISION_PLANNER_DISPLAY_HEADING, SEQUENCE_OUTPUT_CHANNEL_KEY);
    params.placeEntryFragmentColor =
      GLColor(config.getValueAsString(DECISION_PLANNER_DISPLAY_HEADING, ENTRY_FRAGMENT_COLOR_KEY));
    params.placeExitFragmentColor =
      GLColor(config.getValueAsString(DECISION_PLANNER_DISPLAY_HEADING, EXIT_FRAGMENT_COLOR_KEY));
...
goal_planner_display_params_t load_goal_planner_display_params(const utils::ConfigFile& config)
{
    ...
    params.globalLocationColor =
      GLColor(config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, GLOBAL_LOCATION_COLOR_KEY));
    ...
    params.pathSegmentVertexColor =
      GLColor(config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, SEGMENT_VERTEX_COLOR_KEY));
    ...
    params.visitedElementColor =
      GLColor(config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, VISITED_ELEMENT_COLOR_KEY));
    params.activeElementColor =
      GLColor(config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, ACTIVE_ELEMENT_COLOR_KEY));
    params.remainingElementColor =
      GLColor(config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, REMAINING_ELEMENT_COLOR_KEY));

    params.routeCommandOutputChannel =
      config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, ROUTE_COMMAND_OUTPUT_CHANNEL_KEY);
    params.goalTargetOutputChannel =
      config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, GOAL_TARGET_OUTPUT_CHANNEL_KEY);
    params.setGlobalLocationOutputChannel =
      config.getValueAsString(GOAL_PLANNER_DISPLAY_HEADING, GLOBAL_LOCATION_OUTPUT_CHANNEL_KEY);

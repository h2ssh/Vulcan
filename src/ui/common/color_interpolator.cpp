...
LinearColorInterpolator::LinearColorInterpolator(void) : interval(1.0f)
{
}
...
GLColor CircularColorInterpolator::calculateColor(float value, ValueRange range, float alpha) const
{
...
std::vector<GLColor>
  CircularColorInterpolator::calculateColors(const std::vector<float>& values, ValueRange range, float alpha) const
{

...
: UIMainFrame(parent, id, title, pos, size, style)
{
    ...
    localMetricNotebookPanel =
      new wxPanel(mapEditorNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* localMetricPanelSizer;
    localMetricPanelSizer = new wxBoxSizer(wxHORIZONTAL);

    metricEditorWidget =
      new MetricEditorWidget(localMetricNotebookPanel, ID_METRIC_EDITOR_WIDGET, wxDefaultPosition, wxDefaultSize);
    ...
    metricMapLoadSizer =
      new wxStaticBoxSizer(new wxStaticBox(localMetricNotebookPanel, wxID_ANY, wxT("Map Options")), wxVERTICAL);

    loadMetricFromFileButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                            ID_LOAD_METRIC_FROM_FILE_BUTTON,
                                            wxT("Load From File"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            0);
    ...
    captureMetricFromLCMButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                              ID_CAPTURE_METRIC_FROM_LCM_BUTTON,
                                              wxT("Capture From LCM"),
                                              wxDefaultPosition,
                                              wxDefaultSize,
                                              0);
    metricMapLoadSizer->Add(captureMetricFromLCMButton, 0, wxALL | wxEXPAND, 5);

    createMetricButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                      ID_CREATE_METRIC_BUTTON,
                                      wxT("Create Empty"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      0);
    ...
    saveToFileMetricButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                          ID_SAVE_TO_FILE_METRIC_BUTTON,
                                          wxT("Save To File"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          0);
    ...
    sendViaLCMMetricButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                          ID_SEND_VIA_LCM_METRIC_BUTTON,
                                          wxT("Send Via LCM"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          0);
    ...
    importFromImageButton = new wxButton(metricMapLoadSizer->GetStaticBox(),
                                         ID_IMPORT_FROM_IMAGE_BUTTON,
                                         wxT("Import From Image"),
                                         wxDefaultPosition,
                                         wxDefaultSize,
                                         0);
    ...
    cellEditingSizer =
      new wxStaticBoxSizer(new wxStaticBox(localMetricNotebookPanel, wxID_ANY, wxT("Cell Editing Options")),
                           wxVERTICAL);

    wxString editCellTypeRadioBoxChoices[] = {wxT("Hazard"),
                                              wxT("Quasi-Static"),
                                              wxT("Occupied"),
                                              wxT("Free"),
                                              wxT("Unobserved")};
    int editCellTypeRadioBoxNChoices = sizeof(editCellTypeRadioBoxChoices) / sizeof(wxString);
    editCellTypeRadioBox = new wxRadioBox(cellEditingSizer->GetStaticBox(),
                                          ID_EDIT_CELL_TYPE_RADIO_BOX,
                                          wxT("Cell Type"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          editCellTypeRadioBoxNChoices,
                                          editCellTypeRadioBoxChoices,
                                          1,
                                          wxRA_SPECIFY_COLS);
    editCellTypeRadioBox->SetSelection(0);
    cellEditingSizer->Add(editCellTypeRadioBox, 0, wxALL | wxEXPAND, 5);

    cellEditModeButton = new wxToggleButton(cellEditingSizer->GetStaticBox(),
                                            ID_CELL_EDIT_MODE_BUTTON,
                                            wxT("Edit Cells"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            0);
    ...
    lineEditMetricButton = new wxToggleButton(cellEditingSizer->GetStaticBox(),
                                              ID_LINE_EDIT_METRIC_BUTTON,
                                              wxT("Line"),
                                              wxDefaultPosition,
                                              wxDefaultSize,
                                              0);
    ...
    floodEditMetricButton = new wxToggleButton(cellEditingSizer->GetStaticBox(),
                                               ID_FLOOD_EDIT_METRIC_BUTTON,
                                               wxT("Flood"),
                                               wxDefaultPosition,
                                               wxDefaultSize,
                                               0);
    ...
    undoCellsButton = new wxButton(cellEditingSizer->GetStaticBox(),
                                   ID_UNDO_CELLS_BUTTON,
                                   wxT("Undo"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   0);
    ...
    saveCellsButton = new wxButton(cellEditingSizer->GetStaticBox(),
                                   ID_SAVE_CELLS_BUTTON,
                                   wxT("Save"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   0);
    ...
    localTopoEditorWidget =
      new LocalTopoEditorWidget(localTopoNotebookPanel, ID_LOCAL_TOPO_EDITOR_WIDGET, wxDefaultPosition, wxDefaultSize);
    ...
    labeledDataSizer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoNotebookPanel, wxID_ANY, wxT("Labeled Data:")), wxVERTICAL);

    labelDataList = new wxListCtrl(labeledDataSizer->GetStaticBox(),
                                   ID_LABEL_DATA_LIST,
                                   wxDefaultPosition,
                                   wxDefaultSize,
    ...
    loadLabelsButton = new wxButton(labeledDataSizer->GetStaticBox(),
                                    ID_LOAD_LABELS_BUTTON,
                                    wxT("Load Labels"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    0);
    ...
    saveLabelsButton = new wxButton(labeledDataSizer->GetStaticBox(),
                                    ID_SAVE_LABELS_BUTTON,
                                    wxT("Save Labels"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    0);
    ...
    trainGatewaysButton = new wxButton(labeledDataSizer->GetStaticBox(),
                                       ID_TRAIN_GATEWAYS_BUTTON,
                                       wxT("Train Gateways"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       0);
    ...
    trainAndTestButton = new wxButton(labeledDataSizer->GetStaticBox(),
                                      ID_TRAIN_AND_TEST_BUTTON,
                                      wxT("Train Areas"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      0);
    ...
    trainingDataSizer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoNotebookPanel, wxID_ANY, wxT("Training Data:")), wxVERTICAL);

    trainingDataList = new wxListBox(trainingDataSizer->GetStaticBox(),
                                     wxID_ANY,
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     0,
    ...
    addTrainingDataButton = new wxButton(trainingDataSizer->GetStaticBox(),
                                         ID_ADD_TRAINING_DATA_BUTTON,
                                         wxT("  +  "),
                                         wxDefaultPosition,
                                         wxDefaultSize,
                                         wxBU_EXACTFIT);
    ...
    removeTrainingDataButton = new wxButton(trainingDataSizer->GetStaticBox(),
                                            ID_REMOVE_TRAINING_DATA_BUTTON,
                                            wxT("  -  "),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            wxBU_EXACTFIT);
    ...
    testDataSizer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoNotebookPanel, wxID_ANY, wxT("Test Data:")), wxVERTICAL);

    testDataList =
      new wxListBox(testDataSizer->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_MULTIPLE);
    ...
    addTestDataButton = new wxButton(testDataSizer->GetStaticBox(),
                                     ID_ADD_TEST_DATA_BUTTON,
                                     wxT("  +  "),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     wxBU_EXACTFIT);
    ...
    removeTestDataButton = new wxButton(testDataSizer->GetStaticBox(),
                                        ID_REMOVE_TEST_DATA_BUTTON,
                                        wxT("  -  "),
                                        wxDefaultPosition,
                                        wxDefaultSize,
                                        wxBU_EXACTFIT);
    ...
    localTopoEditOptionsScroll =
      new wxScrolledWindow(localTopoNotebookPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL);
    ...
    localTopoIOOptionsSIzer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoEditOptionsScroll, wxID_ANY, wxT("I/O Options")), wxVERTICAL);

    loadLocalTopoLPMButton = new wxButton(localTopoIOOptionsSIzer->GetStaticBox(),
                                          ID_LOAD_LOCAL_TOPO_FROM_FILE_BUTTON,
                                          wxT("Load Map"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          0);
    ...
    storeLabelsButton = new wxButton(localTopoIOOptionsSIzer->GetStaticBox(),
                                     ID_STORE_LABELS_BUTTON,
                                     wxT("Store Map Info"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     0);
    storeLabelsButton->SetToolTip(
      wxT("Save the hand-created gateways and hand-labels areas associated with the current map."));

    localTopoIOOptionsSIzer->Add(storeLabelsButton, 0, wxALL | wxEXPAND, 5);

    currentMapNameLabel = new wxStaticText(localTopoIOOptionsSIzer->GetStaticBox(),
                                           wxID_ANY,
                                           wxT("Current Map:"),
                                           wxDefaultPosition,
                                           wxDefaultSize,
    ...
    currentMapNameText = new wxStaticText(localTopoIOOptionsSIzer->GetStaticBox(),
                                          wxID_ANY,
                                          wxT("None"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
    ...
    localTopoEditModeRadio = new wxRadioBox(localTopoEditOptionsScroll,
                                            ID_LOCAL_TOPO_EDIT_MODE_RADIO,
                                            wxT("Edit Mode"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            localTopoEditModeRadioNChoices,
                                            localTopoEditModeRadioChoices,
                                            1,
                                            wxRA_SPECIFY_COLS);
    ...
    gatewayEditingOptionsSizer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoEditOptionsScroll, wxID_ANY, wxT("Gateway Options")), wxVERTICAL);

    generateGatewaysButton = new wxButton(gatewayEditingOptionsSizer->GetStaticBox(),
                                          ID_AUTO_GENERATE_GATEWAYS_BUTTON,
                                          wxT("Auto-Generate"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          0);
    ...
    handCreateGatewaysButton = new wxToggleButton(gatewayEditingOptionsSizer->GetStaticBox(),
                                                  ID_HAND_CREATE_GATEWAYS_BUTTON,
                                                  wxT("Hand-Create"),
                                                  wxDefaultPosition,
                                                  wxDefaultSize,
                                                  0);
    ...
    loadGatewaysButton = new wxButton(gatewayEditingOptionsSizer->GetStaticBox(),
                                      ID_LOAD_GATEWAYS_BUTTON,
                                      wxT("Load From File"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      0);
    loadGatewaysButton->SetToolTip(
      wxT("Load the gateways from the .gwy file stored in the same directory as the LPM."));

    gatewayEditingOptionsSizer->Add(loadGatewaysButton, 0, wxALL | wxEXPAND, 5);

    createAreasFromGatewaysButton = new wxButton(gatewayEditingOptionsSizer->GetStaticBox(),
                                                 ID_CREATE_AREAS_FROM_GATEWAYS_BUTTON,
                                                 wxT("Create Areas"),
                                                 wxDefaultPosition,
                                                 wxDefaultSize,
                                                 0);
    createAreasFromGatewaysButton->SetToolTip(
      wxT("Create areas from the gateways that have been created for the current map."));
    ...
    localAreaLabelingOptionsSizer =
      new wxStaticBoxSizer(new wxStaticBox(localTopoEditOptionsScroll, wxID_ANY, wxT("Labeling Options")), wxVERTICAL);
    ...
    labelToAssignRadio = new wxRadioBox(localAreaLabelingOptionsSizer->GetStaticBox(),
                                        ID_LABEL_TO_ASSIGN_RADIO,
                                        wxT("Label to Assign"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
                                        labelToAssignRadioNChoices,
    ...
    assignLabelsButton = new wxToggleButton(localAreaLabelingOptionsSizer->GetStaticBox(),
                                            ID_ASSIGN_LABELS_BUTTON,
                                            wxT("Assign Labels"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            0);
    ...
    labelAllAreasButton = new wxButton(localAreaLabelingOptionsSizer->GetStaticBox(),
                                       ID_LABEL_ALL_AREAS_BUTTON,
                                       wxT("Label Remaining"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       0);
    ...
    clearLocalAreaLabelsButton = new wxButton(localAreaLabelingOptionsSizer->GetStaticBox(),
                                              ID_CLEAR_LOCAL_AREA_LABELS_BUTTON,
                                              wxT("Clear Labels"),
                                              wxDefaultPosition,
                                              wxDefaultSize,
                                              0);
    ...
    simplifyViaLabelsButton = new wxButton(localAreaLabelingOptionsSizer->GetStaticBox(),
                                           ID_SIMPLIFY_VIA_LABELS_BUTTON,
                                           wxT("Simplify Via Labels"),
                                           wxDefaultPosition,
                                           wxDefaultSize,
                                           0);
    ...
    localAreaMergeOptions =
      new wxStaticBoxSizer(new wxStaticBox(localTopoEditOptionsScroll, wxID_ANY, wxT("Merge Options")), wxVERTICAL);

    selectLocalAreasButton = new wxToggleButton(localAreaMergeOptions->GetStaticBox(),
                                                ID_SELECT_LOCAL_AREAS_BUTTON,
                                                wxT("Select Areas"),
                                                wxDefaultPosition,
                                                wxDefaultSize,
                                                0);
    ...
    mergeSelectedAreasButton = new wxButton(localAreaMergeOptions->GetStaticBox(),
                                            ID_MERGE_SELECTED_AREAS_BUTTON,
                                            wxT("Merge Selected"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            0);
    ...
    clearSelectedAreasButton = new wxButton(localAreaMergeOptions->GetStaticBox(),
                                            ID_CLEAR_SELECTED_AREAS_BUTTON,
                                            wxT("Clear Selected"),
                                            wxDefaultPosition,
                                            wxDefaultSize,
                                            0);
    ...
    resetMergedAreasButton = new wxButton(localAreaMergeOptions->GetStaticBox(),
                                          ID_RESET_MERGED_AREAS_BUTTON,
                                          wxT("Reset Merged"),
                                          wxDefaultPosition,
                                          wxDefaultSize,
                                          0);
    ...
    globalTopoNotebookPanel =
      new wxPanel(mapEditorNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* globalTopoPanelSizer;
    globalTopoPanelSizer = new wxBoxSizer(wxHORIZONTAL);

    globalTopoEditorWidget = new GlobalTopoEditorWidget(globalTopoNotebookPanel,
                                                        ID_GLOBAL_TOPO_EDITOR_WIDGET,
                                                        wxDefaultPosition,
                                                        wxDefaultSize);
...
ImportImageDialogBase::ImportImageDialogBase(wxWindow* parent,
                                             wxWindowID id,
                                             const wxString& title,
                                             const wxPoint& pos,
                                             const wxSize& size,
...
: wxDialog(parent, id, title, pos, size, style)
{
    ...
    imageFilenameText =
      new wxTextCtrl(this, ID_IMAGE_FILENAME_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    selectImageSizer->Add(imageFilenameText, 1, wxALL, 5);

    selectImageButton =
      new wxButton(this, ID_SELECT_IMAGE_BUTTON, wxT("Select Image"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    imageDimensionsDescriptionLabel =
      new wxStaticText(this, wxID_ANY, wxT("Dimensions (cells):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    freeThresholdText =
      new wxTextCtrl(this, ID_FREE_THRESHOLD_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    imagePropertiesSizer->Add(freeThresholdText, 1, wxALL | wxEXPAND, 5);

    occupiedThresholdLabel =
      new wxStaticText(this, wxID_ANY, wxT("Occupied (0-255):"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    occupiedThresholdText =
      new wxTextCtrl(this, ID_OCCUPIED_THRESHOLD_TEXT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    ...
    cancelImportButton =
      new wxButton(this, ID_CANCEL_IMPORT_BUTTON, wxT("Cancel"), wxDefaultPosition, wxDefaultSize, 0);
...
ClassificationTestResultsDialogBase::ClassificationTestResultsDialogBase(wxWindow* parent,
                                                                         wxWindowID id,
                                                                         const wxString& title,
                                                                         const wxPoint& pos,
                                                                         const wxSize& size,
...
: wxDialog(parent, id, title, pos, size, style)
{
    ...
    classificationResultsSummaryLabel =
      new wxStaticText(this, wxID_ANY, wxT("Summary:"), wxDefaultPosition, wxDefaultSize, 0);
    classificationResultsSummaryLabel->Wrap(-1);
    classificationResultsSummaryLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
    ...
    trainingSetResultsLabel =
      new wxStaticText(this, wxID_ANY, wxT("Training Data:"), wxDefaultPosition, wxDefaultSize, 0);
    trainingSetResultsLabel->Wrap(-1);
    trainingSetResultsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                            wxFONTFAMILY_DEFAULT,
                                            wxFONTSTYLE_NORMAL,
                                            wxFONTWEIGHT_BOLD,
                                            false,
    ...
    trainingResultsTotalLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                              wxFONTFAMILY_DEFAULT,
                                              wxFONTSTYLE_NORMAL,
                                              wxFONTWEIGHT_BOLD,
                                              false,
    ...
    trainingResultsCorrectLabel =
      new wxStaticText(this, wxID_ANY, wxT("Correct:"), wxDefaultPosition, wxDefaultSize, 0);
    trainingResultsCorrectLabel->Wrap(-1);
    trainingResultsCorrectLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                                wxFONTFAMILY_DEFAULT,
                                                wxFONTSTYLE_NORMAL,
                                                wxFONTWEIGHT_BOLD,
                                                false,
    ...
    trainingResultsAccuracyLabel =
      new wxStaticText(this, wxID_ANY, wxT("Accuracy:"), wxDefaultPosition, wxDefaultSize, 0);
    trainingResultsAccuracyLabel->Wrap(-1);
    trainingResultsAccuracyLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                                 wxFONTFAMILY_DEFAULT,
                                                 wxFONTSTYLE_NORMAL,
                                                 wxFONTWEIGHT_BOLD,
                                                 false,
    ...
    testDataResultsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                         wxFONTFAMILY_DEFAULT,
                                         wxFONTSTYLE_NORMAL,
                                         wxFONTWEIGHT_BOLD,
                                         false,
    ...
    totalClassificationTestsLabel =
      new wxStaticText(this, wxID_ANY, wxT("Total:"), wxDefaultPosition, wxDefaultSize, 0);
    totalClassificationTestsLabel->Wrap(-1);
    totalClassificationTestsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                                  wxFONTFAMILY_DEFAULT,
                                                  wxFONTSTYLE_NORMAL,
                                                  wxFONTWEIGHT_BOLD,
                                                  false,
    ...
    correctClassificationTestsLabel =
      new wxStaticText(this, wxID_ANY, wxT("Correct:"), wxDefaultPosition, wxDefaultSize, 0);
    correctClassificationTestsLabel->Wrap(-1);
    correctClassificationTestsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                                    wxFONTFAMILY_DEFAULT,
                                                    wxFONTSTYLE_NORMAL,
                                                    wxFONTWEIGHT_BOLD,
                                                    false,
    ...
    classificationAccuracyLabel =
      new wxStaticText(this, wxID_ANY, wxT("Accuracy:"), wxDefaultPosition, wxDefaultSize, 0);
    classificationAccuracyLabel->Wrap(-1);
    classificationAccuracyLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                                wxFONTFAMILY_DEFAULT,
                                                wxFONTSTYLE_NORMAL,
                                                wxFONTWEIGHT_BOLD,
                                                false,
    ...
    detailedResultsLabel->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(),
                                         wxFONTFAMILY_DEFAULT,
                                         wxFONTSTYLE_NORMAL,
                                         wxFONTWEIGHT_BOLD,
                                         false,
    ...
    classificationDetailsList =
      new wxDataViewListCtrl(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxDV_HORIZ_RULES | wxDV_ROW_LINES);
    ...
    saveClassifierButton =
      new wxButton(this, ID_SAVE_CLASSIFIER_BUTTON, wxT("Save Classifier"), wxDefaultPosition, wxDefaultSize, 0);
    classificationResultsButtonsSizer->Add(saveClassifierButton, 0, wxALL, 5);

    closeClassifierButton =
      new wxButton(this, ID_CLOSE_CLASSIFIER_BUTTON, wxT("Close"), wxDefaultPosition, wxDefaultSize, 0);

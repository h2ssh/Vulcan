...
EditorFrame::EditorFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : UIMainFrame( parent, id, title, pos, size, style )
{
	...
	loadMetricFromFileButton = new wxButton( localMetricNotebookPanel, ID_LOAD_METRIC_FROM_FILE_BUTTON, wxT("Load From File"), wxDefaultPosition, wxDefaultSize, 0 );
	metricMapLoadSizer->Add( loadMetricFromFileButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	captureMetricFromLCMButton = new wxButton( localMetricNotebookPanel, ID_CAPTURE_METRIC_FROM_LCM_BUTTON, wxT("Capture From LCM"), wxDefaultPosition, wxDefaultSize, 0 );
	metricMapLoadSizer->Add( captureMetricFromLCMButton, 0, wxALL|wxEXPAND, 5 );
	
	createMetricButton = new wxButton( localMetricNotebookPanel, ID_CREATE_METRIC_BUTTON, wxT("Create Empty"), wxDefaultPosition, wxDefaultSize, 0 );
	metricMapLoadSizer->Add( createMetricButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	saveToFileMetricButton = new wxButton( localMetricNotebookPanel, ID_SAVE_TO_FILE_METRIC_BUTTON, wxT("Save To File"), wxDefaultPosition, wxDefaultSize, 0 );
	metricMapLoadSizer->Add( saveToFileMetricButton, 0, wxALL|wxEXPAND, 5 );
	
	sendViaLCMMetricButton = new wxButton( localMetricNotebookPanel, ID_SEND_VIA_LCM_METRIC_BUTTON, wxT("Send Via LCM"), wxDefaultPosition, wxDefaultSize, 0 );
	metricMapLoadSizer->Add( sendViaLCMMetricButton, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	importFromImageButton = new wxButton( localMetricNotebookPanel, ID_IMPORT_FROM_IMAGE_BUTTON, wxT("Import From Image"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	editCellTypeRadioBox = new wxRadioBox( localMetricNotebookPanel, ID_EDIT_CELL_TYPE_RADIO_BOX, wxT("Cell Type"), wxDefaultPosition, wxDefaultSize, editCellTypeRadioBoxNChoices, editCellTypeRadioBoxChoices, 1, wxRA_SPECIFY_COLS );
	editCellTypeRadioBox->SetSelection( 0 );
	cellEditingSizer->Add( editCellTypeRadioBox, 0, wxALL|wxEXPAND, 5 );
	
	cellEditModeButton = new wxToggleButton( localMetricNotebookPanel, ID_CELL_EDIT_MODE_BUTTON, wxT("Edit Cells"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lineEditMetricButton = new wxToggleButton( localMetricNotebookPanel, ID_LINE_EDIT_METRIC_BUTTON, wxT("Line"), wxDefaultPosition, wxDefaultSize, 0 );
	lineAndFloodButtonSizer->Add( lineEditMetricButton, 0, wxALL, 5 );
	
	floodEditMetricButton = new wxToggleButton( localMetricNotebookPanel, ID_FLOOD_EDIT_METRIC_BUTTON, wxT("Flood"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	undoCellsButton = new wxButton( localMetricNotebookPanel, ID_UNDO_CELLS_BUTTON, wxT("Undo"), wxDefaultPosition, wxDefaultSize, 0 );
	editingUndoSaveSizer->Add( undoCellsButton, 0, wxALL, 5 );
	
	saveCellsButton = new wxButton( localMetricNotebookPanel, ID_SAVE_CELLS_BUTTON, wxT("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	labelDataList = new wxListCtrl( localTopoNotebookPanel, ID_LABEL_DATA_LIST, wxDefaultPosition, wxDefaultSize, wxLC_HRULES|wxLC_REPORT|wxLC_VRULES );
	...
	loadLabelsButton = new wxButton( localTopoNotebookPanel, ID_LOAD_LABELS_BUTTON, wxT("Load Labels"), wxDefaultPosition, wxDefaultSize, 0 );
	trainAndTestSizer->Add( loadLabelsButton, 0, wxALL|wxEXPAND, 5 );
	
	saveLabelsButton = new wxButton( localTopoNotebookPanel, ID_SAVE_LABELS_BUTTON, wxT("Save Labels"), wxDefaultPosition, wxDefaultSize, 0 );
	trainAndTestSizer->Add( saveLabelsButton, 0, wxALL|wxEXPAND, 5 );
	
	trainGatewaysButton = new wxButton( localTopoNotebookPanel, ID_TRAIN_GATEWAYS_BUTTON, wxT("Train Gateways"), wxDefaultPosition, wxDefaultSize, 0 );
	trainAndTestSizer->Add( trainGatewaysButton, 0, wxALL, 5 );
	
	trainAndTestButton = new wxButton( localTopoNotebookPanel, ID_TRAIN_AND_TEST_BUTTON, wxT("Train Areas"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	trainingDataList = new wxListBox( localTopoNotebookPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_MULTIPLE ); 
	...
	addTrainingDataButton = new wxButton( localTopoNotebookPanel, ID_ADD_TRAINING_DATA_BUTTON, wxT("  +  "), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	trainingDataButtonsSizer->Add( addTrainingDataButton, 0, wxALL, 5 );
	
	removeTrainingDataButton = new wxButton( localTopoNotebookPanel, ID_REMOVE_TRAINING_DATA_BUTTON, wxT("  -  "), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	testDataList = new wxListBox( localTopoNotebookPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_MULTIPLE ); 
	...
	addTestDataButton = new wxButton( localTopoNotebookPanel, ID_ADD_TEST_DATA_BUTTON, wxT("  +  "), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	testDataButtonsSizer->Add( addTestDataButton, 0, wxALL, 5 );
	
	removeTestDataButton = new wxButton( localTopoNotebookPanel, ID_REMOVE_TEST_DATA_BUTTON, wxT("  -  "), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	loadLocalTopoLPMButton = new wxButton( localTopoEditOptionsScroll, ID_LOAD_LOCAL_TOPO_FROM_FILE_BUTTON, wxT("Load Map"), wxDefaultPosition, wxDefaultSize, 0 );
	localTopoIOOptionsSIzer->Add( loadLocalTopoLPMButton, 0, wxALL|wxEXPAND, 5 );
	
	storeLabelsButton = new wxButton( localTopoEditOptionsScroll, ID_STORE_LABELS_BUTTON, wxT("Store Map Info"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	currentMapNameLabel = new wxStaticText( localTopoEditOptionsScroll, wxID_ANY, wxT("Current Map:"), wxDefaultPosition, wxDefaultSize, 0 );
	currentMapNameLabel->Wrap( -1 );
	localTopoIOOptionsSIzer->Add( currentMapNameLabel, 0, wxALIGN_LEFT|wxALL, 5 );
	
	currentMapNameText = new wxStaticText( localTopoEditOptionsScroll, wxID_ANY, wxT("None"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	generateGatewaysButton = new wxButton( localTopoEditOptionsScroll, ID_AUTO_GENERATE_GATEWAYS_BUTTON, wxT("Auto-Generate"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	handCreateGatewaysButton = new wxToggleButton( localTopoEditOptionsScroll, ID_HAND_CREATE_GATEWAYS_BUTTON, wxT("Hand-Create"), wxDefaultPosition, wxDefaultSize, 0 );
	gatewayEditingOptionsSizer->Add( handCreateGatewaysButton, 0, wxALL|wxEXPAND, 5 );
	
	loadGatewaysButton = new wxButton( localTopoEditOptionsScroll, ID_LOAD_GATEWAYS_BUTTON, wxT("Load From File"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	createAreasFromGatewaysButton = new wxButton( localTopoEditOptionsScroll, ID_CREATE_AREAS_FROM_GATEWAYS_BUTTON, wxT("Create Areas"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	labelToAssignRadio = new wxRadioBox( localTopoEditOptionsScroll, ID_LABEL_TO_ASSIGN_RADIO, wxT("Label to Assign"), wxDefaultPosition, wxDefaultSize, labelToAssignRadioNChoices, labelToAssignRadioChoices, 1, wxRA_SPECIFY_COLS );
	labelToAssignRadio->SetSelection( 0 );
	localAreaLabelingOptionsSizer->Add( labelToAssignRadio, 0, wxALL|wxEXPAND, 5 );
	
	assignLabelsButton = new wxToggleButton( localTopoEditOptionsScroll, ID_ASSIGN_LABELS_BUTTON, wxT("Assign Labels"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaLabelingOptionsSizer->Add( assignLabelsButton, 0, wxALL|wxEXPAND, 5 );
	
	labelAllAreasButton = new wxButton( localTopoEditOptionsScroll, ID_LABEL_ALL_AREAS_BUTTON, wxT("Label Remaining"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaLabelingOptionsSizer->Add( labelAllAreasButton, 0, wxALL|wxEXPAND, 5 );
	
	clearLocalAreaLabelsButton = new wxButton( localTopoEditOptionsScroll, ID_CLEAR_LOCAL_AREA_LABELS_BUTTON, wxT("Clear Labels"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaLabelingOptionsSizer->Add( clearLocalAreaLabelsButton, 0, wxALL|wxEXPAND, 5 );
	
	simplifyViaLabelsButton = new wxButton( localTopoEditOptionsScroll, ID_SIMPLIFY_VIA_LABELS_BUTTON, wxT("Simplify Via Labels"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	selectLocalAreasButton = new wxToggleButton( localTopoEditOptionsScroll, ID_SELECT_LOCAL_AREAS_BUTTON, wxT("Select Areas"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaMergeOptions->Add( selectLocalAreasButton, 0, wxALL|wxEXPAND, 5 );
	
	mergeSelectedAreasButton = new wxButton( localTopoEditOptionsScroll, ID_MERGE_SELECTED_AREAS_BUTTON, wxT("Merge Selected"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaMergeOptions->Add( mergeSelectedAreasButton, 0, wxALL|wxEXPAND, 5 );
	
	clearSelectedAreasButton = new wxButton( localTopoEditOptionsScroll, ID_CLEAR_SELECTED_AREAS_BUTTON, wxT("Clear Selected"), wxDefaultPosition, wxDefaultSize, 0 );
	localAreaMergeOptions->Add( clearSelectedAreasButton, 0, wxALL|wxEXPAND, 5 );
	
	resetMergedAreasButton = new wxButton( localTopoEditOptionsScroll, ID_RESET_MERGED_AREAS_BUTTON, wxT("Reset Merged"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	this->Layout();
	editorStatusBar = this->CreateStatusBar( 1, wxST_SIZEGRIP, wxID_ANY );
...
ClassificationTestResultsDialogBase::ClassificationTestResultsDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	classificationResultsSummaryLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	trainingSetResultsLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	trainingResultsTotalLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	trainingResultsCorrectLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	trainingResultsAccuracyLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	testDataResultsLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	totalClassificationTestsLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	correctClassificationTestsLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	classificationAccuracyLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	detailedResultsLabel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );

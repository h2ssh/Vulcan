...
LogplayerUI::LogplayerUI(wxWindow* parent,
                         wxWindowID id,
...
: wxFrame(parent, id, title, pos, size, style)
{
    ...
    fileOpenMenuItem =
      new wxMenuItem(fileMenu, ID_FILE_OPEN_MENU_ITEM, wxString(wxT("Open")), wxEmptyString, wxITEM_NORMAL);
    fileMenu->Append(fileOpenMenuItem);

    wxMenuItem* fileQuitMenuItem;
    fileQuitMenuItem =
      new wxMenuItem(fileMenu, ID_FILE_QUIT_MENU_ITEM, wxString(wxT("Quit")), wxEmptyString, wxITEM_NORMAL);
    ...
    logFileText = new wxStaticText(this,
                                   ID_LOGFILE_TEXT,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxDefaultSize,
    ...
    logPositionSlider = new wxSlider(this,
                                     ID_LOG_POSITION_SLIDER,
                                     50,
                                     0,
                                     100,
                                     wxDefaultPosition,
    ...
    playbackSpeedText = new wxTextCtrl(this,
                                       ID_PLAYBACK_SPEED_TEXT,
                                       wxT("1.0"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       wxTE_NO_VSCROLL | wxTE_PROCESS_ENTER | wxTE_CENTER);

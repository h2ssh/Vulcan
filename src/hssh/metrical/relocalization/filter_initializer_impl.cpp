...
RegionFilterInitializer::RegionFilterInitializer(const math::Rectangle<float>& region, int numPositions, int posesPerPosition)
: region_(region)
                                                                           ...
                                                                           const metric_slam_data_t& data) const
{
    ...
    {
        generate_uniform_samples_at_position(Point<double>(0.0, 0.0),
                                             posesPerCell_ * 5,
                                             0.1,
                                             samples);
    }

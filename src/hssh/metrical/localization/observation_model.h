 ...
 *
 * Declaration of ObservationModel abstract base class for different potential observation models and the
 * create_observation_model() factory.
 */
...
/**
 * create_observation_model is a factory that creates a new observation model based on the provided model name and
 * parameters.
 */
std::unique_ptr<ObservationModel> create_observation_model(const std::string& modelName,
                                                           const observation_model_params_t& params);

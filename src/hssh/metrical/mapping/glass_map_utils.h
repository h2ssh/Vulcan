 ...
 *
 * The angle range is the complete range of angles in which a hit was registered. It isn't a contiguous hit range
 * though, meaning there might be some free or unknown bins between the hits. Given the nature of the grid, where not
 * all angles are viewed for a given cell, this approach gives a better approximation of the range from which a
 * particular cell is seen.
 *

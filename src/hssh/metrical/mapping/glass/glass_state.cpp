...
Mat_<int> flips  ;      //the number of times a cell has changed from believed occupied to believed unoccupied(will be useful for static occupancy calculation)
...
//Sets
set<int> active;    //the cells that are actively needing processing this time around, kept updated to corespond to cells where belief >0

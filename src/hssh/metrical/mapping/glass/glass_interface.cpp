...
void vulcan::glass::update_glass(const pose_t& currentPose, const polar_laser_scan_t& slamLaser)
{
    ...
    for (int i = 1; i < cartesianScan.numPoints; i++) {
        ...
        glass::laser.ang[i] =
          glass::bot.dir + slamLaser.offset.theta + slamLaser.startAngle + slamLaser.angularResolution * i;
    }
    glass::laser.lo = glass::bot.dir + slamLaser.offset.theta + slamLaser.startAngle;
    glass::laser.hi = glass::bot.dir + slamLaser.offset.theta + slamLaser.startAngle
      + slamLaser.angularResolution * cartesianScan.numPoints;
}

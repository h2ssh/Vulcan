 ...
 *
 *   - find_place_exit_transition finds the exit transition in the provided cycle that corresponds to the exit
 * transition in the corresponding topological visit.
 ...
 * the corresponding topological visit. The function works by matching the entry transition with a transition in the
 * visit and then iterating around the cycle the same number of steps as the exit transition stored in visit to
 * determine which transition was exited.
 *

...
/**
 * next_path_event finds the iterator associated with the next path event to occur for a visit given the number of
 * events that have been considered so far.
 *

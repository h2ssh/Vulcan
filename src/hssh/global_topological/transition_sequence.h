...
public:
    ...
    */
    ...
    /**
    * replaceTransition replaces a particular transition in the sequence. Replacing a transition is used whenever a loop
    * closure is established or a transition that was known prior to construction of the sequence needs to be incorporated
    * into the sequence.
    * 

...
public:
    ...
    /**
    * calculateLogLikelihood calculates the likelihood of a map hypothesis using the most recently arrived set of topology measurements.
    * The calculation should be p(measurements | map)
    *

...
/**
* LPMMatchEvaluator calculates the likelihood of two LPMs being the same. The map matching finds the optimal overlap between
* the stored LPM at a place and the LPM from the current visit.
*

 ...
 *   min_hypotheses_to_expand = minimum number of hypotheses to expand for a given event, even if they are less likely
...
private:
    ...
    void
      addNewPlace(TopoMapPtr& hypothesis, const LargeScaleStar& placeStar, const topology_measurements_t& measurements);
    void
      closeLoops(TopoMapPtr& hypothesis, const LargeScaleStar& placeStar, const topology_measurements_t& measurements);

    void processNewMapHypothesis(TopoMapPtr& child, TopoMapPtr& parent, const topology_measurements_t& measurements);
    void
      calculateHypothesisLikelihood(TopoMapPtr& child, TopoMapPtr& parent, const topology_measurements_t& measurements);

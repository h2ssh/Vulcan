...
* access to these children one-by-one via the nextState method. Along with the children, the generator has a probability
* that provides the probability estimate for the next child that will be generated.
* 

...
public:
    ...
    /**
     * updateLikelihoodHeuristic updates the likelihood heuristic for the given depth. The likelihood change is the
     * ratio of child likelihood (depth) over parent likelihood (depth - 1). The ratio is 1.0 for depth = 0 by
     * definition.
     *

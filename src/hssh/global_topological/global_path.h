 ...
 *
 * The base entity of a GlobalPath is a GlobalPathSegment. The GlobalPathSegment links two places via path transitions.
 * The path transition gives both the place and the associated star segment. These two pieces of information are needed
 * because a GlobalPath can contain a Place multiple times. If a Place appears multiple times, the path transitions
 * provide the distinguishing information about which occurrence of the place is in question.
 *

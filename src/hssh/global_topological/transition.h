...
private:
    ...
    {
        ar(id_, plusArea_, minusArea_, navigable_, explored_);
    }
};
...
/**
 * are_similar_transitions checks if two transitions are similar. Similar transitions have the same navigation status
 * and have the same types of area on each side.
 *

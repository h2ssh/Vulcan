...
public:
     ...
     * the appropriate elevator will be set or created. If the elevator has stopped, the robot will be told to
     * relocalize on a previous floor if one has been saved. Otherwise, a new floor and LPM will be created for the
     * robot.
     *
     ...
     * \return   True if any output has been generated, i.e. the elevator state has triggered some sort of mapping
     * change.
     */

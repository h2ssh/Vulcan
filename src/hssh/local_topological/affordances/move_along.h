...
public:
     ...
     */
    MoveAlongAffordance(const Point<float>& plusEndpoint, const Point<float>& minusEndpoint, TopoDirection direction);
...
private:
    ...
    {
        ar(cereal::base_class<NavigationAffordance>(this), direction_);
    }
};

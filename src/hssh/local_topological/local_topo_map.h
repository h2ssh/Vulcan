...
public:
    ...
    *
    * Two areas may share cells along their boundary. In these cases, the first area stored in the map will be returned.
    * The answer will be consistent, but this means they may be slightly flickering exactly on the gateway boundary
    * of two areas.
    *
    * \param    position            Position to check for an area

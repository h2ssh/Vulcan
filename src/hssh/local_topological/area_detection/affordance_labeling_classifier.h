 ...
 */
class AffordanceLabelingClassifier
: public AreaClassifier
...
private:
    ...
    std::unique_ptr<local_area_debug_info_t> debug;   // used to break the dependency with debug_info.h, which has many
                                                      // includes and could trigger lots of recompilation

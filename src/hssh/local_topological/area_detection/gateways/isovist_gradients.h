...
inline bool operator<(const position_value_t& lhs, const position_value_t& rhs)
{
...
/**
 * VoronoiIsovistGradients contains gradient information for a VoronoiIsovistField. The gradient for each isovist
 * doesn't contain direction information, just the magnitude, which suffices to get a feel for how things are changing
 * in the map.
 *

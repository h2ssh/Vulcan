...
public:
    ...
    */
    ...
    /**
    * calculateStar calculates the small-scale star of the area using the specified mask for the matching hypothesis types.
    * If the Hypothesis doesn't have an associated SmallScaleStarBuilder, then an empty star will be returned.
    *
    ...
    */
    ...
    /**
    * isValid checks if the hypothesis is valid. Invalid hypotheses have a single malformed edge. This edge will only have
    ...
    * will be the type that was assigned on construction, which is AREA by default, or via setType(type), but might be different if constructed
    * via the merge constructor.
    */
    ...
    */
    ...
    /**
    * setType sets the default type for the AreaHypothesis. This is the type returned when there has been no CSP assignment
    * made for the hypothesis. In the event that a CSP assignment exists, that is the type that will be returned.
    */
...
private:
    ...
    */
    ...
    HypothesisContainment singleBoundaryContainment(const AreaNode* lhsNode,

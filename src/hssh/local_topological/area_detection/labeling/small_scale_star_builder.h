...
/**
 * SmallScaleStarBuilder is an interface for classes handling the task of creating the small-scale star representation
 * of a place based on the active gateways bounding it.
 *
 * A number of choices exist in the implementation of the small-scale star. The particulars of all SmallScaleStarBuilder

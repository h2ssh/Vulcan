...
public:
    ...
    /**
     * calculateMaximumLikelihoodType calculates the maximum likelihood for a type using the features only. No
     * constraints are considered during the calculation.
     */

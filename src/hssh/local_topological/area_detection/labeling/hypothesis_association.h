...
/**
 * AreaHypothesisAssociation associates the AreaHypotheses contained in two HypothesisGraphs. The association between
 * the areas is determined using the following criteria:
 *

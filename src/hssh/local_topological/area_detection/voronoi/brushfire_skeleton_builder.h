...
*
*   - FREE
*       0) The cell is FREE or DYNAMIC in the occupancy grid and surrounded by FREE, DYNAMIC, OCCUPIED, or UNKNOWN cells.
*
*   - OCCUPIED
...
private:
    ...
    struct brushfire_node_t
    {
        ...
        bool operator<(const brushfire_node_t& rhs) const
        {
    ...
    friend bool compareNodes(const BrushfireSkeletonBuilder::brushfire_node_t& lhs, const BrushfireSkeletonBuilder::brushfire_node_t& rhs);

...
public:
     ...
     * \param    farFromOccupiedDistance     Minimum distance a cell needs to be from the edge of a frontier to be
     * considered far from the frontier
     */
     ...
     * \return   The associated frontier. Frontier with id == INVALID_FRONTIER if this cell doesn't belong to a
     * frontier.
     */
     ...
     * \return   True if the cell belongs to a frontier and is far from the edge of the frontier, as deemed by the
     * farFromOccupiedDistance provided in the constructor.
     */

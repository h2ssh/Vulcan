...
/**
* find_path_along_skeleton finds the path along the skeleton from a starting point to an end point. The type of skeleton
* to follow is determined by the provided mask.
*
* The search first finds a path from the start to the skeleton and skeleton to goal. It then searches for a path between
* these two points to create the full path.
*
...
* \return   A voronoi_path_t containing the cells from the start to the goal. If no path is found, there will be no cells.
*/

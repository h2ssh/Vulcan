...
public:
     ...
     *
     * \param    maxIslandAreaInCells        Maximum number of cells in a connected components for it to be considered
     * an island
     */
...
private:
    ...
    // Can make all methods const because cellIsOnIsland is a const method in that repeated calls will always produce
    // the same results

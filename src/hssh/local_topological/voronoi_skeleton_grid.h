...
public:
    ...
    void
      addClassification(int x,
                        int y,
                        skeleton_cell_type_t classification);   // bitwise-or classification onto the cell classificatin
    void removeClassification(int x,
                              int y,
                              skeleton_cell_type_t classification);   // keep everything but this classification

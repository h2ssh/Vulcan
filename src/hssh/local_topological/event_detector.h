 ...
 *
 * The event detector needs information about the pose of the robot to work. Poses should be added via the addPose
 * method at least as often as the local topology is recalculated. Adding every calculated pose is fine.
 *
...
public:
    ...
    /**
     * detectEvents detects local topological events occurring in the robot's local surround. The current area the robot
     * is in, along with all tracked areas are provided to the method. The types of events detected are determined by
     * the loaded detectors, specified in the parameters for EventDetector.
     *

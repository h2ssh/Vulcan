...
int main(int argc, char** argv)
{
    ...
    arguments.push_back(
      {kDirectoryArg, "Directory where learned classifiers are stored.", true, "../data/classifiers/"});
    ...
    arguments.push_back({kOneShotArg,
                         "Provide an LPM to process in a single-go. Need to also specify MapName and SaveMapArg.",
                         true,
                         ""});

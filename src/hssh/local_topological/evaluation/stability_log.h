...
/**
* AreaStabilityLog is a utility for loading the contents of a sensor log into RAM. AreaStabilityLog exists to avoid needing to use
...
*
* A AreaStabilityLog instance is created by providing an LCM log. This log will be read and converted into the appropriate data

 ...
 *
 *   ./train_area_classifier --labels 'maps.lbl' --output-dir 'path_to_output_directory' --config-file
 * 'local_topo_hssh.cfg'
 */
...
int main(int argc, char** argv)
{
    ...
    arguments.push_back({utils::kConfigFileArgument,
                         "Configuration file for calculating local topo features",
                         true,
                         "local_topo_hssh.cfg"});
    ...
    if (cmdLine.argumentExists(kAllArg) || cmdLine.argumentExists(kGwyArg)) {
        ...
        //             "...\n\n\n"; incr.fileExt = kIncrementalExt; learn_gateway_classifier(incr,
        //             cmdLine.argumentValue(kOutputDirArg));
        //         }
    }
    ...
    if (cmdLine.argumentExists(kAllArg) || cmdLine.argumentExists(kAreaArg)) {
        ...
        //         "...\n\n\n"; incr.fileExt = kIncrementalExt; learn_hypothesis_classifier(incr,
        //         cmdLine.argumentValue(kOutputDirArg)); learn_boundary_classifier(incr,
        //         cmdLine.argumentValue(kOutputDirArg));
        //     }
    }

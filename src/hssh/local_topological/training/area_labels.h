 ...
 *
 * The LabeledAreaData stored in the .feat file is returned. The .cell file is used to associated the ground-truth
 * labels with the underlying map, whose representation isn't going to change. The local topo representation isn't
 * completely solidified yet, and thus isn't as suitable for storing long-term data.
 *

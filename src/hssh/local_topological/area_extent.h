...
public:
     ...
     *
     * Attempts to use an extent that is default will result in pain, but some circumstances it to float around for a
     * bit.
     */
    AreaExtent(void) { }
...
private:
    ...
    {
        ar(center_, polygon_, rectangle_, cells_, perimeter_, area_, frontierRatio_);
    }

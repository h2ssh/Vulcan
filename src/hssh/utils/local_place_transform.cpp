                                                     ...
                                                     const local_path_fragment_t& referenceFragment)
{
    ...
    std::cout<<"DEBUG:local_place_transform:Current:"<<currentFragment.gateway.boundary<<" Reference:"<<referenceFragment.gateway.boundary
             <<" Matcher: "<<matcher<<" Initial:"<<initialGuess<<" Best:"<<best<<'\n';
    #endif

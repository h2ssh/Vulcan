...
struct simulator_robot_group_message_t
{
    ...
    simulator_robot_group_message_t(void) : robots_num_(0), pose_(), robot_config_("") { }

    // Serialization support
    template <class Archive>
    void serialize(Archive& ar)
    {
        ar(robots_num_, pose_, robot_config_);
    }
};
...
private:
    ...
    void initRobotObject(robot_params_t robot_params,

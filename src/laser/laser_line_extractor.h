...
namespace vulcan
{
namespace sensors { struct laser_scan_t; }
...
*
*   split_and_merge    : recursively split lines around point furthest from line, after all lines generated, merge close lines back together
*   quick_split        : essentially split_and_merge without the merge step
*   incremental        : start with line of a minimum length, keep increasing length until line model is bad, move on to next line

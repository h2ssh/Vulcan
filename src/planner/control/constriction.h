...
* skeleton. A constriction is defined as the local minima along each edge where the distance between the obstacles falls
* below some provided threshold. A constriction is bounded by where the distance between the obstacle goes above the
* maximum constriction width. The constriction has a minimum that specifies the closest point between the obstacles.
* 

...
int main(int argc, char** argv)
{
    ...
    arguments.push_back({kMapOption, "The map to be explored. Exact format depends on explorer. Currently, should be a .ltm file.", true, ""});
    ...
    std::unique_ptr<MapExplorer> explorer = create_map_explorer(commandLine.argumentValue(kExplorerOption),
                                                                commandLine.argumentValue(kMapOption),
                                                                config);

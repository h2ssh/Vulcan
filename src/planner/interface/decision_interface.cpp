...
//         }
//         
//         // The fragments are ordered from the outward angles. The right/left distinction when entering is the inbound
//         // direction which is the opposite of outbound. Thus, the fragments to the robot's left are those to the right
//         // in the star
...
void create_action_for_transition_affordance(const hssh::TransitionAffordance& transition, 
                                             ...
                                             std::vector<Decision>& actions)
{
    actions.emplace_back(direction,
                         areaType,
                         transition.target().toPoint(),
                         transition.target().theta,
                         isAbsolute);
}

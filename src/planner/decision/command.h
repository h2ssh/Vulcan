...
* controlling the Decision level, then Append/Prepend are good for user interaction because they allow for incrementally
* navigating through the environment without the need to check the completion status of previously issued commands.
*

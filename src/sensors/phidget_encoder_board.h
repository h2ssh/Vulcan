...
private:
    ...
    friend int phidget_encoder_error_handler (CPhidgetHandle encoder, void* phidgetInstance, int errorCode, const char* errorDescription);
    friend int phidget_position_change       (CPhidgetEncoderHandle encoder, void* phidgetInstance, int index, int time, int relativePosition);

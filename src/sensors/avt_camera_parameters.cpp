...
avt_config_file_index_t config_index_from_string(const std::string& configString)
{
    ...
    {
        std::cerr<<"WARNING: load_avt_camera_parameters: Unknown config file index, "<<configString<<". Defaulting to 'factory'\n";
    }
...
avt_pixel_format_t pixel_format_from_string(const std::string& formatString)
{
    ...
    {
        std::cerr<<"WARNING: load_avt_camera_parameters: Unknown pixel format, "<<formatString<<". Defaulting to 'default'\n";
    }

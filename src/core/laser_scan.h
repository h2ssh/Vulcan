...
{
    int32_t laserId;                    ///< Unique id assigned to the source laser --- guaranteed to start at 0 and be sequential for each new laser added

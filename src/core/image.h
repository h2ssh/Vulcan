...
enum Colorspace
{
    ...
    YUV,       ///< Another brightness invariant colorspace like HSV with the advantage that the format is supported in
               ///< hardware
...
private:
    ...
    void serialize(Archive& ar, const unsigned int version)
    {
        ...
        ar(cereal::binary_data(pixels, size), timestamp);
    }
};

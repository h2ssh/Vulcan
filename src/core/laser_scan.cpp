...
void polar_scan_to_cartesian_scan_in_robot_frame(const polar_laser_scan_t& polarScanInRobotFrame,
                                                 ...
                                                 bool filterBadValues)
{
    polar_scan_to_cartesian_scan_in_robot_frame(polarScanInRobotFrame,
                                                polarScanInRobotFrame.offset,
...
void polar_scan_to_cartesian_scan_in_global_frame(const polar_laser_scan_t& polarScanInRobotFrame,
                                                  ...
                                                  bool filterBadValues)
{
    polar_scan_to_cartesian_scan_in_global_frame(polarScanInRobotFrame,
                                                 polarScanInRobotFrame.offset,
...
void polar_to_cartesian_global_3dof(const polar_laser_scan_t& polarScanInLaserFrame,
                                    ...
                                    bool filterBadValues)
{
    float globalLaserX = robotPoseInGlobalFrame.x
      + (laserPoseInRobotFrame.x * cos(robotPoseInGlobalFrame.theta)
         - laserPoseInRobotFrame.y * sin(robotPoseInGlobalFrame.theta));
    float globalLaserY = robotPoseInGlobalFrame.y
      + (laserPoseInRobotFrame.x * sin(robotPoseInGlobalFrame.theta)
         + laserPoseInRobotFrame.y * cos(robotPoseInGlobalFrame.theta));

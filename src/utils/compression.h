...
* 3.reads from current symbol shall not occur when in points to end (assert before current_symbol) assert(current_point!=end);
* 4.reads frome current symbol are equivalent to memory access
*

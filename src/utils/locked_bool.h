...
public:
     ...
     */
    LockedBool(bool value = false) : value(value) { }
     ...
     */
    LockedBool(const LockedBool& lb) : value(lb.value.load()) { }
     ...
     */
    LockedBool& operator=(bool newVal)
    {
        setValue(newVal);
        return *this;
    }
     ...
     */
    LockedBool& operator=(const LockedBool& newVal)
    {

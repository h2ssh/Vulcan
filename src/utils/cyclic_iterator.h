...
: public boost::iterator_facade<cyclic_iterator<Iter>,
...
private:
    ...
    typename std::iterator_traits<Iter>::reference dereference(void) const { return *it_; }
    ...
    {
        return (other.it_ == it_) && (other.cyclesToGo_ == cyclesToGo_);
    }
 ...
 */
template <class Iter>
std::pair<cyclic_iterator<Iter>, cyclic_iterator<Iter>>
  make_cyclic_iterator(Iter start, Iter begin, Iter end, int numCycles = 1)
{

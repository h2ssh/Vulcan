...
using VisGraphType =
  boost::adjacency_list<boost::vecS, boost::vecS, boost::undirectedS, VisibilityGraphVertex, VisibilityGraphEdge>;
...
public:
     ...
     *
     * Create a VisibilityGraph from a collection of points. Each pair of points is tested for visibility within the
     * graph. If the points are visible, an edge is added between them.
     */

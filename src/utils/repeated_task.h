...
public:
    ...
    */
    ...
    /**
    * join waits for the thread to finish executing. If the task hasn't been killed, then join might never return, depending
    * on the nature of the task being executed.
    */
